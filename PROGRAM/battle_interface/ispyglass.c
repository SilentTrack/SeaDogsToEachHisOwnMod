...
void SetSpyGlassData()
{
	...
	if(CheckAttribute(chref,"Ship.Type")) 
	{
		...
		if (iShip != SHIP_NOTUSED)
		{
			...
			if(ShipsTypes[iShip].name == "fort")
			{
				...
				{
					shipType = XI_ConvertString("Fort_Name");
				}
    ...
    float fDistance = stf(FloatToString(Ship_GetDistance2D(GetMainCharacter(), chref), 1)); 
...
void Net_SetSpyGlassData()
{
	...
	string shipType = XI_ConvertString(NetShips[nShipIdx].Name);
...
void FillISpyGlassParameters()
{
  ...
  objISpyGlass.lens.pos = (nHCenter-sti(showWindow.bottom))+","+(sti(showWindow.top)-1)+","+(nHCenter+sti(showWindow.bottom))+","+showWindow.bottom;
	...
	objISpyGlass.text.crew.pos = 60+","+(ntop+80);
  ...
  objISpyGlass.captext.boarding.scale = fBaseScale * 1.2;
	...
	objISpyGlass.nationuvarray.uv0 = "0.125,0,0.25,1.0"; 
	objISpyGlass.nationuvarray.uv1 = "0.25,0,0.375,1.0"; 
	objISpyGlass.nationuvarray.uv2 = "0.5,0,0.625,1.0"; 
	objISpyGlass.nationuvarray.uv3 = "0,0,0.125,1.0"; 
	objISpyGlass.nationuvarray.uv4 = "0.625,0,0.75,1.0"; 
	objISpyGlass.nationuvarray.uv5 = "0.75,0,0.875,1.0"; 
	
	objISpyGlass.chargeuvarray.uv0 = "0.0,0.5,0.125,0.625"; 
	objISpyGlass.chargeuvarray.uv1 = "0.125,0.5,0.25,0.625"; 
	objISpyGlass.chargeuvarray.uv2 = "0.25,0.5,0.375,0.625"; 
	objISpyGlass.chargeuvarray.uv3 = "0.375,0.5,0.5,0.625"; 
	
	objISpyGlass.sailuvarray.uv0 = "0.5,0.25,0.625,0.375"; 
	objISpyGlass.sailuvarray.uv1 = "0.375,0.25,0.5,0.375"; 
	objISpyGlass.sailuvarray.uv2 = "0.25,0.25,0.375,0.375"; 
}
