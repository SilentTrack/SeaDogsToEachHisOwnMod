////    boal грабеж магазина-города 17.10.06 копи€ store.c
string totalInfo = "";
int  TableSelect = 0;
int	nCurScrollNum = 0;
int iShipCapacity;
...
void InitInterface_R(string iniName, ref pStore)
{
	...
	GameInterface.TABLE_LIST.hr.td2.str = "¬ес";
...
void ShowFoodInfo()
{
	...
	{
		// чтоб прикинуть как оно будет, скинем на врем€ колво на продажное
...
void TransactionOK()
{
	...
	AddToTable();
	EndTooltip();
	ShowGoodsInfo(iCurGoodsIdx); //сбросим все состо€ни€
}
