...
void LaunchRansackMain(ref _refMy,ref _refEnemy,string captureState)
{
	if(procInterfacePrepare(INTERFACE_RANSACK_MAIN))
	{
		...
		InitInterface_RS(Interfaces[CurrentInterface].IniFile,_refEnemy,captureState); // ��� ����������, _refMy �� ��� ����� ������ :) �������, ����� �����. �� ��, ������������� ���.
	}
	// ��� �� ���� ����� LaunchTransferMain(_refMy, _refEnemy, captureState); , �� ����� �������� ��	INTERFACE_RANSACK_MAIN 
}
...
void EndOkInterface()
{
	...
	if(nPrevInterface == INTERFACE_STORE)
	{
		...
		if(cn!=-1)
		{
			...
			CurrentInterface = INTERFACE_STORE;
			LoadSegment(Interfaces[CurrentInterface].SectionName);
			InitInterface_RR(Interfaces[CurrentInterface].IniFile,GetCharacter(cn),&stores[gStoreNum]);  // to_do ��������?
		}
		else
		{
			IDeleteSoundEvents();
...
void ReloadAfterFortCapture()
{
    ...
    bool ExitToSea = CheckAttribute(pchar, "from_interface.Exit_to_Sea"); // ����� � ���� to_do
	// boal <--
    ...
    pchar.GenQuest.Hunter2Pause = true;  // boal ����� � �����
	// ����
	// boal -->
    ...
    fOldMaxSeaHeight = 0.6; // fix ����� � ����� �� boal 03.01.05
    // boal <--
	if(sToLocation != "")
	{
...
int GetPlayTimeHours() // ugeen 2016 - ����� ��� ������
{
	int hours = sti( InterfaceStates.GameTime.hour );
	//int days = hours / 24; 
	//hours = hours - days*24;
