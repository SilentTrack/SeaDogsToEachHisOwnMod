...
int LocationInitBoarding(int n)
{
	...
	Locations[n].models.day.l2 = "capmd_bd"; 
	Locations[n].models.day.l2.level = 65538;
	Locations[n].models.day.locators = "capmd_lbd"; 
	Locations[n].models.day.charactersPatch = "capmd_pbd"; 
	Locations[n].models.day.fonar = "capmd_fd"; 

	
	Locations[n].models.night.l3 = "capmd_bn"; 
    Locations[n].models.night.l3.level = 65538;
    Locations[n].models.night.locators = "capmd_lbn";  
    Locations[n].models.night.charactersPatch = "capmd_pbn"; 
	...
	Locations[n].models.day.l2 = "capmd_md"; 
    Locations[n].models.day.l2.level = 65538;
    Locations[n].models.day.locators = "capmd_lmd"; 
    Locations[n].models.day.charactersPatch = "capmd_pmd"; 
    Locations[n].models.day.fonar = "capmd_fd";

	
	Locations[n].models.night.l3 = "capmd_mn"; 
    Locations[n].models.night.l3.level = 65538;
    Locations[n].models.night.locators = "capmd_lmn"; 
    Locations[n].models.night.charactersPatch = "capmd_pmn"; 
    Locations[n].models.night.fonar = "capmd_fn";
