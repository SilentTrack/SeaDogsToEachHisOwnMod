...
int LocationInitTortuga(int n)
{
	...
	locations[n].reload.l24.name = "houseS6"; 
	...
	locations[n].reload.l31.name = "houseH4"; 
	...
	locations[n].reload.l34.name = "houseF4"; 
	...
	locations[n].reload.l36.name = "houseSp5"; 
	...
	locations[n].id = "Tortuga_townhallRoom"; 
	locations[n].id.label = "Room";
