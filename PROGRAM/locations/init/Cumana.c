...
int LocationInitCumana(int n)
{
	...
	locations[n].id = "Cumana_TownhallRoom"; 
	...
	Locations[n].models.always.locators = "shore02_lcommon"; 
	...
	Locations[n].models.always.locators = "shore03_lcommon"; 
