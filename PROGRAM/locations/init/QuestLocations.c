...
int LocationInitQuestLocations(int n)
{
	...
	////////////////////////////////////////////////////////////
	///  орабельна€ палуба  дл€ карта - море
	////////////////////////////////////////////////////////////
	...
	// нельз€, иначе нет мор€ Locations[n].boarding = "true";
	...
	////////////////////////////////////////////////////////////
	///  вестова€ корабельна€ палуба  дл€ море - море
	////////////////////////////////////////////////////////////
    //ID
	...
	locations[n].type.LSC = true; //локаци€ √ѕ 
	locations[n].dolly = 2;
	//Models
	//Always	
	...
	locations[n].private7.key = "key_betancur"; // сундук Ѕетанкура
	locations[n].private7.key.delItem = true;
	locations[n].private7.money = 100000; 
	locations[n].private7.items.gold_dublon = 500;
	locations[n].private7.items.icollection = 12; // чтоб удавитьс€ от жадности
