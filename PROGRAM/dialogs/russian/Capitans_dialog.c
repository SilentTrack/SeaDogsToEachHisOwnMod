...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Talk_Capture_City":
            ...
            SiegeRumour("They say you had helped our squadron in the assault of the "+NationNameSK(sti(aData.conation))+" colony - "+GetConvertStr(aData.Colony+" Town", "LocLables.txt")+"! �� ��� ���������� ���, "+ GetAddress_Form(NPChar)+".", "", sti(aData.nation), -1, 30, 3);
