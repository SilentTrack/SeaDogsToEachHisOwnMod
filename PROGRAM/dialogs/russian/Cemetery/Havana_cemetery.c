...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "caleuche":
			...
			link.l1 = "HmmÖ And why are you stuttering and looking down? You know, I think that you're lying to me. Now tell me - have you seen that man?";
			link.l1.go = "caleuche_1";
		break;
		
		case "caleuche_1":
			dialog.text = "I-I am telling y-you, senor, I h-haven't seen anyone! I am s-stuttering s-since I was a child...";
			link.l1 = "You lie. I can see it in your eyes. Where is Merryman? Tell me!";
		...
		case "caleuche_2":
			...
			link.l1 = "Oh, really? AlrightÖ Listen now and pay attention: Joachim Merryman is a warlock. The Holy Inquisition is looking for him. Many years ago, in Europe, he was sentenced to burning at the stake for grave digging, defilement of the dead and witchcraft. And I know for certain that now he's hiding somewhere in the vicinity of Havana...";
			link.l1.go = "caleuche_3";
		break;
		
		case "caleuche_3":
			dialog.text = "";
			link.l1 = "...recently I have cleared the nearby cave of zombies. And I know whose work it is! Ha! Surely, where else would Merryman go, if not to the cemetery! You know where he is. Alright, I won't even touch you with a finger, but I'll go to the inquisitors in Santiago and tell Father Vincento, that Joachim Merryman is hiding in Havana's cemetery, and the local watchman is his accomplice...";
			link.l1.go = "caleuche_4";
		break;
		
		case "caleuche_4":
			dialog.text = "";
			link.l1 = "... Why have you turned white in an instant? I give you a nobleman's word: in a day after my report everything will be crawling with Spanish soldiers here, and you, stretched on the rack, will be telling them, where that warlock is hiding. And after that you'd be burnt at the stake as his accomplice, while I shall be watching the auto-da-fe. How would you like that?";
			link.l1.go = "caleuche_5";
		break;
		
		case "caleuche_5":
			dialog.text = "Please, senor! I am not partaking in any of this, I swear! IÖ I just couldn't do anything... How could I stand against him? He's a terrible man, he can... you have no idea what he can do! Mercy!";
		...
		case "caleuche_6":
			dialog.text = "He... He is hiding in a cave below the cemetery. One can get there only through the chapel's door. When he gets out, I hide in my house and sit there. You have no idea, how much I'd like to get rid of that horror!\nBut I don't dare to even approach. I... I have seen him digging a fresh grave, and then... then the dead man arose and walked around the cemetery in the moonlight! I almost lost my sanity then. But Merryman forbade me to leave. He told me that if I leave my house without his permission even for half a day, he will find me and turn into that abomination... a walking skeleton!";
			link.l1 = "How often does he leave his hiding place?";
			link.l1.go = "caleuche_7";
		break;
		
		case "caleuche_7":
			dialog.text = "I am bringing him food and healing potions from townÖ and whatever else he demands. He gets out once or twice in a monthÖ when the moon is full. He leaves a note at the door where he tells me what he needs, I bring it from town and put it at the door, and he takes it.";
		...
		case "caleuche_8":
			...
			link.l1 = "HmmÖ Merryman is no fool, and surely he must have another exit from his lair, like in his house in Europe. If we start to force the door open, he'd sneak away, and we'll never find him. Hmmm...";
		...
		case "caleuche_10":
			dialog.text = "I know how to get there. There is another keyÖ I have it. Merryman didn't know that there were two keys to that lock. I would never dare to enter, but you..";
		...
		case "caleuche_12":
			dialog.text = "Be very careful, senor. Frightening sounds are coming from his cave, and I fear to even think, who could inhabit it. But Merryman is not alone there - that's fro certain.";
		...
		case "caleuche_13":
			...
			SetFunctionTimerCondition("Caleuche_MerrimanCaveOver", 0, 0, 3, false); // Ú‡ÈÏÂ
