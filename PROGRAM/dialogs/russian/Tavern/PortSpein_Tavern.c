...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Listen, in April 1654 a frigate docked in at your port under the command of captain Miguel Dichoso after which he disappeared. Is there anything you can tell me in regards to this matter?";
		...
		//--> ÷ена чахотки
		case "Consumption":
			dialog.text = "The commandant states that there is no danger. Only for those who have lucked into ending up in a casemate or those who are too curious. I'm not one of them, so Цsorry.";
			link.l1 = "Is that so? The owner of the port saloon has no desire of listening to rumors Цthat's something new! May it be that the clinking of pesos may return your curiosity?";
			link.l1.go = "Consumption_1";
		break;
		
		case "Consumption_1":
			dialog.text = "Silver is tempting of course, but my own skin seems too be higher in value. Maybe I could tell you about something else, gentleman? I'm actually a bit of a chatterbox you just start the conversation!";
		...
		case "Consumption_2":
			...
			dialog.text = "Oh, you are persistent, senior. Just remember this conversation never happened. (whispering) I've heard several times already in the past year that people are burning away in our prisons from consumption. You can blame the authorities, you can blame God or the Devil, but most of it is attributed to ill fortune this damned disease steals lives so fast.  Sometimes they'll put a perfectly healthy man in there and in a week or two he's gone. Just like that...";
		...
		case "Consumption_5":
			dialog.text = "I guess. He was no use to his pals anymore, spending whole day here, drinking to death. Looked like he wanted to erase something from his head. Every time he got drunk, he was telling stories about consumption which takes people in silence\nThat were his exact words. According to him, the 'consumption' is the worst thing that can happen to a man.";
		...
		case "Consumption_6":
			...
			{
				dialog.text = "Nothing, other than the fact that he got gutsy and started talking more and more and then just like that somebody slits his throat and tosses him in the gutter... and whoever did it and what for is all the same to me.";
				link.l1 = "What can you say about the commandant?";
				link.l1.go = "Consumption_8";
			}
			else
			{
				dialog.text = "Nothing, other than the fact that he got gutsy and started talking more and more and then just like that somebody slits his throat and tosses him in the gutter... and whoever did it and what for is all the same to me. (raises his voice) Yes, the bays are so nice here, senior. You have to see both the storms come crashing in from the Greater Antilles an in an instant Цsee ya! Have a nice rest, senior, thanks for stopping by!";
		...
		case "Consumption_9":
			dialog.text = "Well, what can I say... The colonel looks like a man who deeply cares about his own safety. Sure, these places aren't safe due to pirates, bandits, Indians and other scum, but senor commandant never leaves his house without several bodyguards\nThere is his mansion in this city and he has turned it into a small fortress - his servants are well armed and forbidden to open windows.";
			link.l1 = "But in the daytime he serves in the prison, doesn't he?";
			link.l1.go = "Consumption_10";
		break;
		
		case "Consumption_10":
			dialog.text = "Yes, and there's a mansion basically waiting there for an ambush or an invasion. Anyway, senor commandant doesn't often actually return there apparently a true fortress is more his fort, he he.";
		...
		case "Consumption_12":
			dialog.text = "Juan? Which one? There's a lot of them here Цpeople usually have last names too...or at least a nickname...";
			link.l1 = "I was just thinking... Maybe his nickname is 'Consumption', ever heard that?";
			link.l1.go = "Consumption_13";
		break;
		
		case "Consumption_13":
			dialog.text = "Oh my God, you're talking about that again! No, thank God, I haven't. I swear! And now let's change the topic. Please!";
