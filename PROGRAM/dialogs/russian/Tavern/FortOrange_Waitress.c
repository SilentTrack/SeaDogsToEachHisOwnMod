...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Jamaica_ratW_4":
            ...
            link.l1 = "Oh, you saucy bagged! You sure know what to ask for Цyou can't even get a decoration like that from a merchant. All right, you'll get your pendant.";
            link.l1.go = "exit";
