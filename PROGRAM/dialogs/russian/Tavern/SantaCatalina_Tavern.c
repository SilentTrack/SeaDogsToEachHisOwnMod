...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Svenson":
			dialog.text = "This is the first time I've met somebody who doesn't know who the Forest Devil is. That's the nickname that was given to him by the Spanish and they gave a whole bag full of gold for the head of that privateer from Providence Island way back fifteen years ago! Yes, the years fly by... People have already begun to forget about our Jan. Maybe it truly is time for him to rest in peace.";
		...
		case "Svenson_1":
			...
			link.l2 = "Don't give me the runaround! I believe I've asked you a question. I can repeat. Where does Jan Svenson live? I've got a serious conversation for him.";
			link.l2.go = "Svenson_2";
		break;
		
		case "Svenson_2":
			dialog.text = "He lives in a mansion across from the residence of our mayor, next to a fountain. But at the moment he's going through some disconcerted emotions and I wouldn't recommend bothering him unless it's of the utmost importance.";
			link.l1 = "Why's that?";
			link.l1.go = "Svenson_3";			
		break;
		
		case "Svenson_3":
			dialog.text = "His favo�ite Helen, also known as Rumba, a daughter of his late old friend Shawn McArthur, has disappeared. Rest in piece, old man... Jan treats the young devil as his own daughter, since he doesn't have kids of his own. So, the girl has vanished along with her schooner 'Rainbow' and a crew\nI feel bad for the girl. A rare beauty, smart too. Hot as fire, that's why they had called her Rumba! Her father taught her everything he knew, she inherited the ship and every single crewman stayed  on her side. Even the eldest sea wolves recognized her as a captain...";
			link.l1 = "What could have happened with her?";
			link.l1.go = "Svenson_4";			
		break;
		
		case "Svenson_4":
			dialog.text = "Who knows... A week is not that long, but McAthur's widow is confident that something wrong happened to her daughter and she managed to convince Svensson in that. He raised his men and started searching himself with no result yet. 'Rainbow' and her crew just vanished\nI can tell ya where to find Gladys for a thousand pesos.";
