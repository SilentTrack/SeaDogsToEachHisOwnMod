...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "Sharlie_rum_6":
			dialog.text = "Well, here's your reward Цfive thousand. You can keep the spyglass. And also, another little present Цtake these three bottles of rum. After you try it, you'll see right away why there's so much of a demand for it.";
		...
		case "Portugal_2":
			dialog.text = "I wouldn't say that he up and took off by himself, monsieur. Some people came by here yesterday. One of them was a one-eyed tall lanky man Цan obvious bandit by how he looks, lisping too like a Castilian. I was just surprised and that lisper gave me this look...just like a louse Цbefore a pounding. And so they asked about your friend...and I told them. What else was I supposed to do?";
		...
		case "Portugal_3":
			...
			link.l2 = "It's not a lot, but thanks anyway. Next time Цcall the guard and don't be such a squab.";
			link.l2.go = "Portugal_5";
		break;
		
		case "Portugal_4":
			AddMoneyToCharacter(pchar, -1000);
			dialog.text = "Thank you, monsieur. I can give you my word that your friend has almost recovered. He at least was walking by himself. And the second man, that quiet Dutchman Цhe came in off the street. He spotted that pack and leaped outside, but he wasn't seen.";
