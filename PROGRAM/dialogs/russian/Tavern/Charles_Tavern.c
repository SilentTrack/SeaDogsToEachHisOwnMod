...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "valet_1":
			dialog.text = NPCStringReactionRepeat("No, I don't know, buddy. So there's nothing I can help you with.", "I've already told you ЦI don't know!", "Are you drunk or are you just messing around?", "Leave me alone!", "block", 1, npchar, Dialog.CurrentNode);
