...
void ProcessDialogEvent()
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			if(CheckAttribute(pchar,"questTemp.HabitueSpeakDisable") && rand(1) == 0) // если дуэл€нт то каждый второй посылает нафик
			{
        ...
        case "talk_with_alchogol_song":
			dialog.text = "Well, h-hic! Things are goodЕ Hic! You don't see it comingЕ Hi-ic! This rum is fineЕ Jamaica black rumЕ hic!\nHere, put and pour!";
		...
		case "Alcogol_GenQuest_Church_2_6":
			...
			PChar.GenQuest.ChurchQuest_2.WayOfShortVariant = true; // Ќужно дл€ проверки при убийстве банды
		...
		//--> работорговец
			...
			case "EscapeSlave_Villemstad_H4":
				dialog.text = "Oh-hoe, I say that I saw it with my own eyes. It was storming. Couldn't see a thing, and then the ship appeared from nowhereЕ Torn sails. She had her foresail brokenЕ and mainsail, and pot andЕ damn it she had everything broken! And yet she was rushing upwind!\nAnd there were apes on her deck... a lot of them like... seal rookery! And a pure gorilla was standing at the wheel! nine feet, red shirt and shark teeth instead of the cross at it's chest... Eyes are red, fangs flashing, it saw us and cried something out...";
		...
		case "Lucas_Tavern_7":
			...
			//ставим прерывание на выход в море ћейфенг
			...
			pchar.quest.Meifeng_fail.over = "yes"; //сн€ть прерывание
			Group_DelCharacter("Meifeng_Empty", "Longway");
			Group_DeleteGroup("Meifeng_Empty");//удалить ћейфенг из порта
		break;
		...
		case "sit_2":
			...
			link.l4 = LinkRandPhrase("Feels like I have spent an eternity in the sea. Any news?",
									"What people say? Surely, I have reasons to buy you drinksЕ",
