...
void ProcessDialogEvent()
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "Alcogol_GenQuest_Church_2_6":
			...
			case "Jamaica_ratH_1":
				dialog.text = "Oh, Fran�ois! Sure, I remember that guy... No, I don't know. But, you know, you can ask our waitress about him. For as long as he'd lived here, she spent every night with him. A bitch she is, that's for sure. Perhaps he'd blabbed out something to her.";
