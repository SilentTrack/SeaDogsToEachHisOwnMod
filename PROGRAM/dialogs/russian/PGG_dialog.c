...
"... No, gentlemen, those are crappy anecdotes. I've got some good stories to fill you ears...\n",
...
"... Ever heard about me being shell shocked at Key West?...\n",
"... Ha-ha-ha!...Good one...\n" 
};
...
"... Can't say much about the Flying Dutchman. Never seen it. I once boarded some odd brigantine, empty, not a single soul onboard. Guess what? 1700 barrels of fine wine in her hold!.. That is what I call luck!...",
"... She killed the poor bastard right in the middle of the tavern after he suggested to test her 'officer skills' upstairs..."
}
...
"Now there's another glorious corsair, who is not used to looking for royal roads.", 
};
...
//		link.l1 = "My name is " + GetFullName(pchar) + ".";
	...
	case "Meeting":
		Dialog.Text = "Well, everyone knows me here! I am " + GetFullName(NPChar) + ". Nice meeting you! What can I do for you?";
		link.l1 = RandPhraseSimple("I have business with you!", "I wanted to talk to you...");
		link.l1.go = "quest";
	...
	case "Second time":
		...
		{
//			Dialog.Text = RandPhraseSimple("Strike a light, look who it ain't! It's " + GetFullName(pchar) + ". Any news?", "How are you doing? What can I do for you?");
			if(rand(10) == 3)
			{
				iRnd = rand(MAX_PGG_QUEST_STORIES - 1);
			...
			if (sti(NPChar.Ship.Type) == SHIP_NOTUSED)
			{
				Dialog.Text = RandPhraseSimple("Oh, woe to me... My ship sank!", "Look who it ain't?! What has brought you here? Myself, I lost my ship...");
...
//==================================================
	case "officer":
		...
		{
			Dialog.Text = RandPhraseSimple("You have already a full set.", "I don't think you're ready командовать мной.");
...
//==================================================
	...
	case "companion_leave":
		Dialog.Text = RandSwear() + " " + NPCharRepPhrase(NPChar,
					...
					RandPhraseSimple("I am tired of youк escapades, 'admiral'... Allow me to take my leave.", "I am sick of your command and I am leaving your squadron."));
	...
	case "companion_stay":
		if (CheckAttribute(NPChar, "Quest.Companion"))
		{
			...
			link.l1 = RandPhraseSimple("Alright, so best of luck to you.", "Then get lost and make sure I never see you again!");
			link.l1.go = "Exit_Companion_Leave";
			break;
		}
		...
		Dialog.Text = RandSwear() + " " + NPCharRepPhrase(NPChar,
					RandPhraseSimple("A premium? Fine! A sum of " + NPChar.Quest.Companion.Price + " pesos will suit me fine.", 
						"Well, perhaps if you were to pay to my crew " + NPChar.Quest.Companion.Price + " pesos, I might persuade them to stay."), 
