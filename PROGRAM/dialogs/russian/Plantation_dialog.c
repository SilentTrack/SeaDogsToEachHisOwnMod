...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Licence":
			...
			{
				PlaySound("VOICE\Russian\soldier_arest_2.wav");
				dialog.text = "A license? Wait a secondЕ Ha-ha, this is funny! You are wanted pal! Seize him!";
				link.l1 = RandPhraseSimple("Say hello to my blade", "Fuck you.");
				link.l1.go = "fight";	
				break;
			}
		...
		// управл€ющий в ћаракайбо // Addon 2016-1 Jason
		case "Plantator":
		...
		case "mtraxx_coffee":
            ...
            dialog.text = "Five hundred boxes of coffee? Well-well... Let's seeЕ (counting) I am ready to exchange your coffee for "+sti(pchar.questTemp.Mtraxx.PlantGood.Sugar)+" sacks of sugar and "+sti(pchar.questTemp.Mtraxx.PlantGood.Cocoa)+"  boxes of cacao. Deal?";
			link.l1 = "M-m-m.. I was hoping for better termsЕ Whatever. Deal!";
			link.l1.go = "mtraxx_6";
		break;
		...
		case "mtraxx_cinnamon":
            ...
            dialog.text = "Five hundred boxes of vanilla? Well-well... Let's seeЕ (counting) I am ready to exchange your vanilla for "+sti(pchar.questTemp.Mtraxx.PlantGood.Sugar)+" sacks of sugar and "+sti(pchar.questTemp.Mtraxx.PlantGood.Cocoa)+"  boxes of cacao. Deal?";
			link.l1 = "M-m-m.. I was hoping for better termsЕ Whatever. Deal!";
			link.l1.go = "mtraxx_6";
		break;
		...
		case "mtraxx_copra":
			...
			pchar.questTemp.Mtraxx.PlantGood.Sugar = i * 100;
			pchar.questTemp.Mtraxx.PlantGood.Cocoa = n * 100;
            dialog.text = "Five hundred boxes of copra? Well-well... Let's seeЕ (counting) I am ready to exchange your copra for "+sti(pchar.questTemp.Mtraxx.PlantGood.Sugar)+" sacks of sugar and "+sti(pchar.questTemp.Mtraxx.PlantGood.Cocoa)+"  boxes of cacao. Deal?";
			link.l1 = "M-m-m.. I was hoping for better termsЕ Whatever. Deal!";
			link.l1.go = "mtraxx_6";
		break;
