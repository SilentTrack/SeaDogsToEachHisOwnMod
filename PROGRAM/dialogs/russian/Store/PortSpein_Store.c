...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "In April 1654 a frigate docked in at your port under the command of captain Miguel Dichoso after which he disappeared. Does his name ring any bells? Possibly, he could have purchased some merchandise from you or said something...";
