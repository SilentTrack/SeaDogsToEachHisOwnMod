...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "Sharlie_storehelper_exit":
			dialog.text = "Hey, monsieur. Who's looking for a job, you or me? If you don't want to, I'm not forcing your hand. Have a nice day.";
			link.l1 = "Hm...";
			link.l1.go = "exit";
		break;
		
		case "Sharlie_storehelper_1":
			dialog.text = "Name's Gralam Lavois. His looks? Thirty five, beard and moustache, long brown coat, white shirt. Oh, and he always wears that bloody cocked hat, pretends to be an admiral, anchor to his arse\nHe is not in St. Pierre, I have checked the whole city. He must be in the jungles or in Les Francois.";
		...
		case "Sharlie_storehelper_2":
			...
			link.l1 = "I've found him in Le Francois. He isn't going to work for you anymore according to his own words. He also added a lot of things about you... Would you be interested in hearing what?";
			link.l1.go = "Sharlie_storehelper_3";
		break;
		
		case "Sharlie_storehelper_3":
			dialog.text = "No. Spare my the details... What a pity! What am I going to do now without an assistant?";
			link.l1 = "Hire some one else. Or is it really as big of a problem as Gralam said it was?";
			link.l1.go = "Sharlie_storehelper_4";
		break;
		
		case "Sharlie_storehelper_4":
			dialog.text = "Rotten luck, indeed. And what did that loafer say?";
			link.l1 = "Well, for starters he's obviously not idling his time, he he. He said that no one in all Saint Pierre would sign up for service with you because...you don't pay your workers enough. Yes, by the way, "+npchar.name+", you owe one thousand pesos as promised.";
			link.l1.go = "Sharlie_storehelper_5";
		break;
		
		case "Sharlie_storehelper_5":
			AddMoneyToCharacter(pchar, 1000);
			dialog.text = "Please, take your money. Ha! A scrooge! Of course, nobody wants to work for me. The bastard did his best to spread dirty talks. What can I do? I can not do everything alone\nI can't go to sleep until I count every piece of cargo and the damn workers always steal pieces...";
			link.l1 = "Well, I don't know what to say to help you out. All right, all the best. It's time for me to go.";
			link.l1.go = "Sharlie_storehelper_6";
		break;
		
		case "Sharlie_storehelper_6":
			dialog.text = "Wait! I think you can help me. If you were able to search out that sun of a gun, then you might well be able to...";
		...
		case "Sharlie_storehelper_11":
			dialog.text = "Have you found a worker for me? Wonderful. Allow me to have a chat with him and come back on by in an hour for your reward.";
			link.l1 = "All right. I'll come back by in an hour.";
		...
		case "Sharlie_storehelper_13":
			switch (sti(pchar.questTemp.Sharlie.Storehelper.Quality))
			{
				case 0:
					...
					dialog.text = "I am quite happy with the worker you've found for me, although he talks the talk more than he can walk the walk. But not to worry, I'll beat his chattering out of him in no time. Your reward is three thousand pesos. Here you go.";
				...
				case 1:
					...
					dialog.text = "You've managed to find a truly valuable worker! He's even better that that scoundrel Gralam. I'm very, very pleased, sir. Here, take your reward Цfive thousand pesos.";
					link.l1 = "Thank you! All the best, monsieur.";
					link.l1.go = "Sharlie_storehelper_14";
				break;
				...
				case 2:
					...
					dialog.text = "You've found a good worker. And although he doesn't know all the tricks of the trade, I'm sure he get a handle on it without much trouble. I'm pleased with you, sir. Here, take your reward Цfour thousand pesos.";
					link.l1 = "Thank you! All the best, monsieur.";
					link.l1.go = "Sharlie_storehelper_14";
				break;
			}
		...
		case "Sharlie_junglejew":
			dialog.text = "Well, they're magnificent earrings. I can give you...let's see... four thousand pesos for them. I doubt anyone will offer you any more. Do we have a deal?";
			link.l1 = "Put her there! It's yours.";
