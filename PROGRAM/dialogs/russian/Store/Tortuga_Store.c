...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth":
			dialog.text = "Gaius Marchais? Oh yes, of course I remember him! Only he didn't purchase anything. He offered his ship for freight. I just happened to need a ship with a spacious hold Цa large batch of raw skins.";
