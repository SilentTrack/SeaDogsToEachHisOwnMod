...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "free_to_officer_Hire":
            ...
            DeleteAttribute(NPChar, "LifeDay") // посто€нный
			Pchar.questTemp.HiringOfficerIDX = GetCharacterIndex(Npchar.id);
			// тут трем накопивщиес€ сабли и корабли 290704 BOAL -->
		...
		case "free_in_sea_battle_all":
			//ugeen --> привет —иварду !!! после релиза пленников кол-во пассажиров уменьшаетс€ и цикл нихрена дальше не срабатывал
		...
		case "FalseTrace_Prisoner_7":
			...
			link.l1 = "I don't like your planЕ I think, that they will organize a hunt for me as soon as I leave the shores of " + XI_ConvertString(pchar.questTemp.FalseTrace.TargetShore+"Gen") + ". No, captain, I am not going to risk my head. Our conversation is over.";
		...
		case "FalseTrace_Prisoner_9":
			...
			pchar.quest.FalseTraceSollyOver.over = "yes"; //сн€ть таймер
