...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "spa_prisoner_9":
			...
			link.l1 = "Listen to what I'm about to tell you: Fort St.Pierre has never stored any silver and the arsenals have never stored ironwood and silk. A now think well, officer, before answering, for if your answer does not please me, I'll turn around and walk away leaving you in your own fate... quite a sorrowful fate.";
		...
		case "spa_prisoner_13":
			dialog.text = "I've got something... But you've got to swear to me that you'll taken me out of here and later hold me for ransom to Spain.";
			link.l1 = "If you tell me something worthy of attention, I swear you'll be delivered on board my vessel and you will escape execution.";
		...
		case "spa_prisoner_18":
			dialog.text = "Miguel Dichoso is a former brother-in-arms of the baron, however they say that he betrayed him. Senior de Mendosa y Riba wants him alive, for we were given an order to not kill Dichoso by no means.";
			link.l1 = "Is Dichoso Spanish?";
			link.l1.go = "spa_prisoner_19";			
		break;
		
		case "spa_prisoner_19":
			dialog.text = "Yes. Don Diego de Montoya has given an approximate description and required everyone falling under him to be delivered directly to him. But in the time that we've spent in the city, we haven't even had time to search for Miguel.";
			link.l1 = "Did you know Dichoso personally?";
			link.l1.go = "spa_prisoner_20";			
		break;
		
		case "spa_prisoner_20":
			dialog.text = "No. There were people in my platoon that know him by sight. All of them are dead.";
		...
		case "spa_prisoner_23":
			dialog.text = "The baron did claim in the heat of the moment that he's sure Dichoso betrayed him. I don't know the details. Then Don Diego de Montoya came around, who as I understand informed the baron that Miguel Dichoso may be in St.Pierre.";
			link.l1 = "Hm. Engaging. Those Indian treasures again. It all looks kind of suspiciously tied to them... So, they didn't end up finding Dichoso?";
		...
		case "spa_prisoner_33":
			...
			link.l1 = "The first is I'll give you a typed letter and you are to deliver it to the inquisitor of Santiago, Father Vincento, personally. If he asks who it's from and how you got it boldly tell him the truth...";
			link.l1.go = "spa_prisoner_34";			
		break;
		
		case "spa_prisoner_34":
			dialog.text = "";
			link.l1 = "The second is that you will not undertake actions of any kind to try to mind my and attack my ship at least for a week. Agreed?";
		...
		case "spa_prisoner_41":
			dialog.text = "Listen, captain, why you be against having a glass, to our meeting, so to speak? I never thought that I would ever offer that to a Frenchman, but you are an exception.";
			link.l1 = "Don't mind if I do. I don't mind rinsing my mouth with some rum. Let's take it to the saloon.";
		...
		case "spa_prisoner_51":
			dialog.text = "Thank you, monsieur. All kinds of good wishes to you to as well. Oh and, I think it's time for me to get going. I'll finish this drink and then take off.";
			link.l1 = "Happy trails, senior "+npchar.name+". Maybe we'll meet each other again some day during a more peaceful time.";
		...
		case "spa_prisoner_53":
			...
			dialog.text = "Just as I told you, Don Diego: the fish swallowed the entire bait...Ope, looks like we meet again, monsieur. Unfortunately not in a peaceful setting as you wished.";
		...
		case "boatsvandega_2":
			dialog.text = "Could a lot of soldiers have done what you did, huh, captain?.. Eh, I would love to treat you to some rum in the tavern, but alas: the captain has forbidden giving so much as a drop of rum to the sailors and I don't want to be the bad example...";
		...
		case "boatsvandega_8":
			dialog.text = "Eh, captain, I sure would love a sip of rum!";
			link.l1 = "...";
			link.l1.go = "exit";
		...
		case "marshe_tavern":
			...
			link.l1 = HeroStringReactionRepeat("Don't worry about it, buddy. It happens.", "Have some rum, captain. It should ease your troubles a bit...", "Don't be nervous, buddy. It's bad for your health.", "All right, all right. I'm going.", npchar, Dialog.CurrentNode); 
		...
		case "marshe_sitground_2":
			dialog.text = "I don't believe my ears... you're Spanish? Oh, no... you're not Spanish! It's even worse! You've sold out to those vile Castilians! What are they buying Frenchmen's souls at these days? I won't tell you any thing. You won't get those your hands on those spiritual gems!";
			link.l1 = "You won't tell me? Ah, to hell with you. This isn't the best place for interrogation... We're gonna put a gag in your mouth to keep you from squealing and then we're going into  my cock boat... you'll still talk anyway buddy. Oh, you'll talk!";
		...
		case "gevarra_3":
			...
			link.l1 = "I need to purchase a batch of vanilla and send it to Cuba, to a man named "+pchar.questTemp.Guardoftruth.LMname+", this is the watchman of the Santiago lighthouse. However, I've gotten serious problems doing that. First of all, no store has the amount of vanilla that I need...";
		...
		case "gevarra_5":
			dialog.text = "I understand. That happens, senor. You can't make all the money in the word. So what do you want from me?";
			link.l1 = "Look over there. See that galleon over there? She's got cargo loads of vanilla that I need dearly. The trouble is the captain of the galleon has drum it up in his stupid head that a caravan will arrive here soon that is going to buy his cargo at a profitable price, at almost three hundred pesos...";
		...
		case "gevarra_10":
			dialog.text = "Santiago is pretty far away...three hundred thousand pesos.";
			link.l1 = "What.";
			link.l1.go = "gevarra_11";			
		break;
		
		case "gevarra_11":
			dialog.text = "All right, it's on my way anyway...Twenty five thousands and not a peso less.";
		...
		case "gevarra_13":
			...
			dialog.text = "We've got a deal if you have the money to pay for the merchandise and the freight.  Do you have them with you?  Show them to me.";
		...
		case "gevarra_14":
			...
			{
				dialog.text = "Wonderful. I love doing business with sensible partners. Come back "+sTemp+" by ten in the morning and I think by that moment you'll client will 'come to fruition'.";
		...
		case "dominica_hunter_1":
			dialog.text = "Suppose I have ties to the sea foxes. You don't need to know that, there's no point. You don't need any kind of knowledge right now. You've found my treasure, which we now owe you a huge thanks for...";
		...
		case "belinda_1":
			dialog.text = "Yes, it is me. With whom do I have the honour of speaking?";
		...
		case "belinda_3":
			dialog.text = "You're well - informed, senor. Anyway, knowing who you are, this shouldn't surprise me. Yes, I acquired this valuable ostensory, for it certainly does not belong stolen in a merchant's shop at the cost of people's tears and grief.";
		...
		case "belinda_6":
			...
			link.l1 = "You are a noble woman, madam. What troubles you?";
			link.l1.go = "belinda_7";
		break;
		
		case "belinda_7":
			dialog.text = "You want to help me? Oh, senor...I wouldn't dare depend on the help of a Jesuit brother himself...";
		...
		case "belinda_9":
			dialog.text = "Fine. I trust you. My very close friend Esteban Sosa has got in trouble, he was captured by bandits and they demand a ransom of one hundred thousand pesos. I don't possess that much money and only managed to collect a half of the sum. I can't ask for anyone's help in such matter\nBesides I worry for my... friend and fear the worst, they may have him killed as soon as they get the coin to make sure that he won' tell a commandant about them. Perhaps you, a brave captain and a brother of Jesus Order could persuade the bandits to accept the sum I have and make sure he stays alive...";
		...
		case "belinda_11":
			dialog.text = "Apparently they understand that I can't put the whole sum together quickly, so they've stated the issue that way... but I can't find that kind of money, I'll never be able to!";
		...
		case "belinda_13":
			dialog.text = "Here, take this. It's fifty thousand. Talk those scums into taking at least this. Tell them I don't have a peso more! Bring Esteban back! And I'll gladly give you the ostensory for Father Vincento.";
			link.l1 = "I'll do everything I can, madam. Let's hope for the best.";
			link.l1.go = "belinda_14";
		break;
		
		case "belinda_14":
			dialog.text = "God save you, courageous captain!";
			link.l1 = "...";
		...
		case "belinda_19_1":
			...
			link.l1 = "I met with the scumbags in the cave. Bartie the Knacker and Esteban Sosa are the exact same person. He staged the kidnapping to get some money out of you. He told me about your... connection. He also said that he would not like to see you anymore. That's how this abomination started. I took a ring of his as proof.";
		...
		case "belinda_20":
			...
			link.l1 = "Senora, I beg of you don't kill yourself over this. This scum isn't worth a single tear of yours. "+sTemp+"";
		...
		case "belinda_21":
			...
			dialog.text = "Oh... I'll try to calm down. Senor, I must thank you for your help. Here, take your ostensory. "+sTemp+"God save you.";
		...
		case "barty_1":
			dialog.text = "What do you care what I look like? You got the money?";
		...
		case "barty_2":
			...
			link.l1 = "Bartie, what do I look like an idiot? Until I see Esteban Sosa alive and kicking, you're not gonna see a peso. Where is he?";
			link.l1.go = "barty_3";
		break;
		...
		case "barty_5":
			...
			dialog.text = "";
			link.l1 = "All right, here, enough dancing for you? Where's Esteban Sosa? Come on, tell me or you're going under water until you open up!";
			link.l1.go = "barty_6";
		break;
		...
		case "barty_7":
			...
			link.l1 = "You waste of life! So, you decided to just suck a hundred thousand out of Belinda by 'kidnapping' yourself?";
			link.l1.go = "barty_8";
		break;
		
		case "barty_8":
			dialog.text = "You understand me, man to man. Belinda...She's really got me browned off with her love. Even her husband started getting a feeling about it...";
			link.l1 = "Well how about that! You're lovers?";
			link.l1.go = "barty_9";
		break;
		
		case "barty_9":
			dialog.text = "Not anymore. I just ran away from her.";
			link.l1 = "And you decided to take some coins for the road, eh? I've got you. Well, what do I do with you now? Drown you in this marsh just as you tried to kill me?";
			link.l1.go = "barty_10";
		break;
		
		case "barty_10":
			dialog.text = "I didn't want any blood, I swear!";
			link.l1 = "Is that why sicked your cutthroats on me?";
			link.l1.go = "barty_11";
		break;
		
		case "barty_11":
			dialog.text = "We were just going to shake your pockets, that's it!";
			link.l1 = "By shooting at me? Buddy, I should string you up on the butt of my ship's sail yard while I'm at it. But out of respect to the good woman that had the misfortune of getting involved with you, I will not do that. I'll take you to her and let her decide what to do with you...";
			link.l1.go = "barty_12";
		break;
		...
		case "barty_13":
			dialog.text = "Spare me, senor! Let me go and I'll just sail away from here and never come to Cumana again! I'm not going to wait for Belinda's husband to gank me in a duel or send a hit man for me...";
		...
		case "spa_hunter_1":
			dialog.text = "I don't even know myself, pal. I've just been ordered to take your stuff, absolutely everything you have on you. Are you gonna give it away yourself or you gonna kick and scream?";
		...
		case "spa_hunter_2":
			dialog.text = "You're a joker boy, aren't you frog eater? Well then, let's find out what colour your entrails are!";
			link.l1 = "The same colour as yours, idiot... Did you go to school?";
