...
void ProcessDialogEvent()
{
	...
	{
		case "First time":
			if (CheckAttribute(pchar, "questTemp.Sharlie.BenuaLoan.Late")) // Addon 2016-1 Jason пиратска€ линейка 1
			{
		...
		// Addon 2016-1 Jason пиратска€ линейка 1
		case "FastStart":
		...
		case "FastStart_1":
			dialog.text = "A-ah, I see. I knew Henri de Monper personally. Turn to the light, young manЕ Right! Same eyes, same noble features! I am pleased to see a son of Henri de Monper in my church. Hope you will help you brother outЕ He had a bad luck recently.";
			link.l1 = "Yes, pater. I need a ship to help Michelle yet I have just recently arrived to the Caribbean and my purse is empty. My brother told me you could lend me some money...";
			link.l1.go = "FastStart_2";	
			npchar.quest.meet = true;
		break;
