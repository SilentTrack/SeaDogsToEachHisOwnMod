...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "treasure_1":
			dialog.text = "My father said: 'Any riches have two side. Only he who know these two side enter to treasures of Tayasal.' What this mean Ц I not know. Maybe, Cavil solve?";
