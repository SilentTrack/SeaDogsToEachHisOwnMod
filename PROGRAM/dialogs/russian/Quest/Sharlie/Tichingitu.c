...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tichingitu":
			...
			link.l1 = "Your name is Tichingitu? Hm. Listen, warrior, I haven't come here to mad dog you. I've come here to ask you a question: What did you intrude into that fatman's home for?";
			link.l1.go = "Tichingitu_1";
		break;
		
		case "Tichingitu_1":
			dialog.text = "";
			link.l1 = "Not saying anything? Not smart. You'll be hung for theft and everything else you've done. Tell me why you committed such an act and maybe I'll be able to help you.";
			link.l1.go = "Tichingitu_2";
		break;
		
		case "Tichingitu_2":
			dialog.text = "Tichingitu come to town of pale faces through many many roads, through big water, from great forests and swamps. Tichingitu is tired and want to eat. Tichingitu die from hunger. No one want help Tichingitu. They yell, 'Go away, red-skinned dog'. Pub owner kick out Indian like mangy dog. Tichingitu want eat.";
			link.l1 = "God damn it, but what did you come to this settlement from... your forest?";
		...
		case "Tichingitu_3":
			...
			link.l1 = "That's what I call a misfortune. Why?";
		...
		case "Tichingitu_6":
			dialog.text = "Tichingitu wait. Indian not afraid of death. Shaman curse Tichingitu must die.";
			link.l1 = "Don't be that pessimistic. You're ordeal has come to an end. I've helped set you free.";
		...
		case "Tichingitu_9":
			dialog.text = "";
			link.l1 = "There you are, free again. Go on, Tichingitu, make sure not to steal anything else or get into any more trouble! You'd be better off finding some Indian village and living with your own kind, I don't think they'd be against accepting you.";
		...
		case "Tichingitu_11":
			dialog.text = "Indian is in debt, white master. Tichingitu serve you faith and truth. Tichingitu know how to fing. Tichingitu die in battle for master. He stay.";
			link.l1 = "Bother! Damn it... What kind of a master am I to you, Tichingitu? I helped you not to turn you into a slave.";
			link.l1.go = "Tichingitu_12";
		break;
		
		case "Tichingitu_12":
			dialog.text = "Tichingitu is not a slave. Tichingitu is a free Indian. Tichingitu wants to serve you. Tichingitu knows how to fight, any dog die before come close to the master. Tichingitu know how to clean and load musket. Tichingitu can shoot musket.";
			link.l1 = "Although... You know, Tichingitu, that's not a bad idea. I need loyal people and you don't seem to be a bad man. And what are you going to do alone anyway? You'll end up stealing something else and next time you'll definitely get hung... All right, you can stay. But remember: life isn't going be calm with me.";
	...
	//--> ----------------------------------- офицерский блок ------------------------------------------
		...
		case "TargetDistance_1":
			...
			if (iTemp < 0)
			{
				dialog.text = "Captain, forgive Tichingitu not understand you.";
