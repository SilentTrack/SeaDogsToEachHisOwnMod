void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
 		...
 		case "Node_3":
			dialog.text = "You are wrong. Your business with that banker was revealed. Soon, the governor-general will learn about your little business and you won't get away from the hallows. But I will do your a favour by slaying you right now and right here!";
		...
		case "Slave_arest_1":
			dialog.text = "Don't try to play stupid, captain! Your dirty business was revealed. And for the slaughter you've committed and for the ships you had sunken, " + NationNameGenitive(sti(npchar.nation)) + " will see you hanged!";
		...
		case "Rat_lover":
    		...
    		link.l1 = "What? Where is Francois Gontier? Answer me, you filthy creature, or you will end you just like those fellows of yours!";
		...
		case "Contraoffer_patrol":
			...
			link.l2 = "What, trading " + GetGoodsNameAlt(iCGood)+ "? I don't see " + GetGoodsNameAlt(iCGood)+ " around, officer. I see only these shiny coins... And he sees the same. Why won't you and your soldiers take a look at them?";
		...
		case "Contraoffer_patrol_1":
			...
			{
				dialog.text = "Don't play stupid, captain! Everyone have been knowing that for a long time. I am arresting you both for smuggling and your cargo is to be confiscated.";
		...
		case "Contraoffer_patrol_pay1":
			...
			if (GetSummonSkillFromName(pchar, SKILL_FORTUNE) > drand(120))
			{
				...
				link.l2 = "Whoa! You are too greedy, officer. Didn't you mom tell you that greed is not good? I suppose that it would be cheaper for me to deal with you with my blade.";
				link.l2.go = "Contraoffer_patrol_fight";
			}
			else
			{
				dialog.text = "Are joking on me, captain? Do you want to offer me a bribe? You are under arrest! Seize him!";
		...
		case "Device_poorman_1_2":
			...
			link.l1 = "Less talking, thief! Don't think that I have trusted you, I just want to do it peacefully. These coins won't do you anything good for you anyway. Get lost!";
			link.l1.go = "exit";
		...
		case "PostProfHunters_3":
			dialog.text = "I am glad that you were reasonable, captain. You have put yourself in a great danger by taking this job. Now I am to take my leave, if you don't mind.";
			link.l1 = "...";
		...
		case "PostAgent_1":
			dialog.text = "I know that you are. And I also know that you have just received a"+pchar.questTemp.WPU.Current.Add+" "+XI_ConvertString("Colony"+pchar.questTemp.WPU.Postcureer.City+"Gen")+". These papers are the reason why I am so eager to talk with you.";
		...
		case "PostAgent_inTavern_4":
			dialog.text = "Don't you worry. I am a professional. Take a sit and have a rest. It will take about an hour.";
			link.l1 = "Fine.";
		...
		case "PostAgent_inTavern_getout":
			...
			link.l1 = "I is you who should pray, spy!";
		...
		case "DisasterCap_1":
			dialog.text = "Oh! And how did you find out about the "+pchar.questTemp.WPU.Escort.ShipName+"? Yes, I am her cap. Or I was... The ship was sunken not far from here.";
		...
		case "DisasterCap_3":
			...
			link.l1 = "Accept my sympathies, captain " + GetFullName(npchar) + ". I am so sorry.";
		...
		case "DisasterCap_8":
			dialog.text = "Fuh, we have made it... See, captain, I have told you that this bay is the hell itself. It is the third Indian attack already! We have got to leave this place as soon as possible, we won't survive another attack.";
		...
		case "Badboy_1":
			...
			link.l1 = "It is pretty simple. There is someone in this town who has had enough of your tricks. This person is fed up of them. Now I look at you and I see why. Don't show up in the local brothel ever again or you will get troubles. Got it?";
			link.l1.go = "Badboy_2";
		break;
			...
			switch (sti(pchar.GenQuest.Badboy.Brothel.Type))
			{
				case 0:
					if (GetSummonSkillFromName(pchar, SKILL_LEADERSHIP) < 30)
					{
						...
						link.l1 = "Prepare yourself, scum!";
						link.l1.go = "Badboy_fight_1";
						NextDiag.currentnode = "Badboy_after_fight";
					}
					else
					{
						dialog.text = "What? What tricks? There were no any tricks. I got drunk and had a spree for a few times in the brothel. Nobody is perfect... All right, all right, I will never use their services again. Satisfied now? You have my word.";
		...
		case "Badboy_after_fight":
			...
			link.l1 = "And now you are talking!";
		...
		case "Badboy_after_fight_1":
			...
			link.l1 = "This pose suits only to a scum like yourself. I hope that that will be your lesson for the rest of your life. And behave yourself properly in this town.";
		...
		case "Badboy_friends":
			...
			link.l1 = "Ah, you such a degenerate! But I have warned you. You and your apes will be sent right to the hell in a minute!";
		...
		case "Sunplace_Store":
			...
			link.l2 = "Hm... No... It is nothing. I looks like I was mistaken. Pardon me for bothering you.";
		...
		case "Sunplace_Store_3":
			...
			link.l1 = "And I thought you will spend your last seconds on praying, it least you could have had a chance to reach the heavens...";
		...
		case "Sunplace_Store_repeat":
			dialog.text = "You again? Why would not you tell me what do you want?";
		...
		case "CitizenNotBlade":
			...
			else
			{
				...
				link.l1 = LinkRandPhrase("I got it.", "I got it.", "Don't worry ...");
			}
			link.l1.go = "exit";
			NextDiag.TempNode = "First Time";
