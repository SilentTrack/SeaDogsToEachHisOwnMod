...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "store_13":
			dialog.text = "�h, "+pchar.name+"  is very brave! Then you should go to uncle Henrick, he will teach you how to walk at the bottom and you will kill every crab there. You will also find there one more big bead for Ole. Right?";
