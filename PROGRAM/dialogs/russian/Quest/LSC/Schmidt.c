	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "�h, "+GetFullName(pchar)+"! I have heard about your deeds. It is good that you have become a Donald's friend and our ally. Narwhals can appreciate friendship, I can tell you that for sure.";
			...
			else
			{
				...
				{
					dialog.text = "�h, "+GetFullName(pchar)+"! Want to chat again? I have to disappoint you, I have got no time and no wish for that.";
		...
		case "Jurgen":
			...
			dialog.text = "�h, "+GetFullName(pchar)+"! What do you want?";
		...
		case "blade_pay": 
			...
			Log_Info("You have given "+sti(npchar.quest.blade_pay)+" ��������");
