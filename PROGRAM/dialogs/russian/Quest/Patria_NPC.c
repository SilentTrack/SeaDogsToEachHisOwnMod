...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "noel_2":
			dialog.text = "I'm pleased that during this journey I will be on your ship, captain. Chevalier de Poincy told me a lot of interesting stories about you. I'm sure that after dinner in the messroom we will have plenty of topic o discuss. A glass of wine could also come in handy";
			link.l1 = "I'm all for a cosy talk, especially when I'm full. I'd be glad to be your companion, baron. ";
			link.l1.go = "noel_3";
		break;
		
		case "noel_3":
			dialog.text = "Perfect. When we go to a colony, I'd ask you to gide me to the governor, and I'll personally explain to them what needs to be done. You'll just wait until I finish my affairs. Deal?";
		...
		case "noel_7":
			dialog.text = "My work un Tortuga is done, it's time to raise the anchor.";
		...
		case "noel_14":
			dialog.text = "Almost there? Weren't we supposed to visit Sint Maarten too? I believe it belongs to the French colonies.";
		...
		case "noel_21":
			dialog.text = "Captain, could you tell me what just happened? Does this mean war? Why in hell's name were we almost sank by the Dutch?";
		...
		case "noel_28":
			dialog.text = "Who do we have here! Vice Admiral Charles de Maure! Glad to see you! How come you are in Port-au-Prince?";
		...
		case "noel_32":
			...
			link.l1 = "Hmm... I don't believe I fully understand you, monsieur ...";
			link.l1.go = "noel_33";
		break;
		
		case "noel_33":
			dialog.text = "Monsieur de Maure, I want to ask you: what do you think of your liege, Governor General Philippe de Poincy?";
			link.l1 = "Officers duty is not to think about his commander, but to follow his orders.";
			link.l1.go = "noel_34";
		break;
		
		case "noel_34":
			dialog.text = "Oh, leave it, Vice Admiral, we're not in the barracks, and not in the de Poincy's hall. I will say this: don't you think, that monsieur de Poincy ... abuses his power? I still can not forget how we almost went down the drain under the guns of Fort Sint Maarten. I am sure that the treachery of the Dutch had a reason.";
		...
		case "noel_35":
			...
			link.l1 = "I risk my life everyone, monsieur Forget. I think you understand that...";
			link.l1.go = "noel_36";
		break;
		...
		case "noel_36":
			...
			link.l1 = "There are numerous mines in the archipelago. Most of them are exhauseted and became worthless. I know of one major operating gold mine, it is owned by the Spaniards on South Maine. But I've never heard of gold mining in Sint Maarten.";
			link.l1.go = "noel_37";
		break;
		...
		case "noel_45":
			dialog.text = "No way!";
			link.l1 = "Yes. We had to go for it, although the result is not the best. No trading French ship can feel safe in the Caribbean now. The Spaniards, who also do not have agreements with pirate barons, at least have a fleet of strong galleons and powerful military galleons capable of repelling the filibusters. Like the Dutch with their East Indies. But we can not boast of such a thing, alas. And French pirates often rob French merchants.";
			link.l1.go = "noel_46";
		break;
		...
		case "noel_47":
			dialog.text = "Hmm...";
			link.l1 = "And you, Monsieur Forget, want to organize a trading company here on the Archipelago. Do you understand now what difficulties you will have to face? How many bastards want to get their share of income here? And they are not going to let go of it easily. And that pirates are capable of erasing all efforts? In order to protect merchant ships, you would have to maintain a military fleet, but will that be profitable from a financial standpoint?";
			link.l1.go = "noel_48";
		break;
		...
		case "noel_53":
			dialog.text = "";
			link.l1 = "Here everyone uses eachother. Chevalier used me in his doings long before I became an officer of the navy.";
			link.l1.go = "noel_54";
		break;
		...
		case "noel_59":
			...
			link.l1 = "I'm sure of it. It seems that Poincy has a new trade ally. It's noone other that Colonel Doily ";
			link.l1.go = "noel_60";
		break;
		...
		case "noel_64":
			dialog.text = "I wrote down all the evidence of your captive, and he signed under them. Now we must fulfill what I promised him: whenever there is a convenient opportunity stop by Cartagena and let him disembark. But you yourself heard everything \ nNow what a scoundrel our Poincy is! Rented an island to the Dutch, conducted illegal activities there and allowed the Spaniards to go there and manage the mine! I'm afraid to imagine how much money the King's treasury is missing!";
			link.l1 = "Will that evidence be enough to charge Poincy?";
			link.l1.go = "noel_65";
		break;
		
		case "noel_65":
			dialog.text = "Unfortunately, I fear it won't. The evidence is very important, but it's not enough. But I don't want you to be involved in all this for reasons we both understand.";
			link.l1 = "The Spaniard agreed to testify before your commission when is arrives here.";
			link.l1.go = "noel_66";
		break;
		...
		case "noel_68":
			dialog.text = "Then, at night, you and I will sneak in there, quietly, so that no one will see, and witness what is going on there.";
			link.l1 = "Good.";
			link.l1.go = "noel_69";
		break;
		...
		case "noel_82":
			dialog.text = "I already thought about it. We will go to Curacao, disembark in a bay far from the city and send our captive Spaniard from the mine with a letter to Styvesant.I will not mention you there, instead I will inform him that I'm leading an investigation against Poincy or something along the lines. I think the Dutchman will come for the rendezvous.";
			link.l1 = "Hmm. I do not think that this is a good idea. The Stuyvesant is no fool, he takes what he can. Well, if you so want, let's try.";
			link.l1.go = "noel_83";
		break;
		...
		case "noel_84":
			...
			link.l1 = "A million... Poincy wants a million, Stuyvesant wants a million... We're going in circles...";
			link.l1.go = "noel_85";
		break;
		
		case "noel_85":
			dialog.text = "What are you on about Vice Admiral?";
		...
		case "noel_86":
			...
			link.l1 = "I earned it and I paid it. Not in a month, of course. Truth be told, I was but a landlubber back then. Chevalier didn't let Michael go.";
			link.l1.go = "noel_87";
		break;
		...
		case "noel_92":
			LAi_Fade("", "");
			dialog.text = "That's it! Our dear Chevalier is doomed. As soon as all this accounting will be seen by the Minister of Finance ... I can't even imagine he will be. We won't even have to look for the Spaniard from Cartagena. Monsieur de Maure, did you really pay million for this book?";
		...
		case "noel_99":
			dialog.text = "Where he's supposed to be: in prison. He was arrested and will be brought to France for investigation and trial. Given his position, he will certainly avoid being in the slammer, but he can't avoid a huge fine, demotion and, probably, imprisonment.";
		...
		case "noel_108":
			dialog.text = "Not to worry. You will get used to your new position. And besides, you were quite successful at being the governor of Sint-Maarten for half a year, so it will be nothing new to you.";
		...
		case "noel_final":
			dialog.text = "Allow me to express my sincerest appreciation for you, vice-admiral! You have saved my life by freeing those damned outlaws from captivity. I thank you, as well as Philippe de Poincy. I must admit, I was absolutely wrong in my judgement of him, and I ask you to forgive me for that. You and the Chevalier were right: the French trading Company will have a lot of trouble here, and it looks like they will only lose money here\nOnly experienced people, like Poincy, and such brave soldiers as you, can withstand these wolves that live on every island here. I need to go to the palace, and after that I shall leave for Europe as soon as possible, and forget this nightmare.";
		...
		case "ecliaton_cap_3":
			...
			link.l1 = "Of course. We will be moving to the Spanish island of Trinidad, located about a week's travel South from here. We shall abruptly attack the fort guarding the San Jose colony and run it into the ground. Then, we will talk with the Spanish about our compensation for the recent attack on the French settlement of Saint-Pierre.";
			link.l1.go = "ecliaton_cap_4";
		break;
		
		case "ecliaton_cap_4":
			dialog.text = "I see. When shall we depart?";
		...
		case "ecliaton_cap_5_1":
			dialog.text = "But, Captain de Maure, first you have to make your squadron smaller - my ship cannot join you, or it will be too large.";
		...
		case "ecliaton_cap_5_3":
			...
			{
				dialog.text = "Have you not yet made the squadron smaller, monsieur?";
		...
		case "ecliaton_cap_11":
			...
			link.l1 = "Prepare the 'Eclatant' for departure. First, we will sail for the coast of Jamaica, and then, together with Colonel Doyley's squadron, we will attack Curacao.";
		...
		case "ecliaton_cap_13":
			...
			link.l1 = "Excellent. Then we shall depart immmediately.";
		...
		case "doily":
			...
			else
			{
				...
				link.l1 = "Indeed, sir. I was sent here by the Governor General of the French colonies, Philippe de Poincy. Saint-Christopher has been besieged by the Spanish and Dutch navy squadrons. The Chevalier asked for help from you, as well as Sir Jonathan Fox. Here is his letter to you, colonel.";
				link.l1.go = "doily_3";
			}
		break;
		...
		case "miner_1":
			...
			link.l1 = "I'm sure you won't have trouble finding a ship from Willemstadt to Cartagena. We gave you all the necessary funds to pay for the trip and for accommodation. And in case you need to - you will confirm your reports in front of the French commission half a year from now?";
			link.l1.go = "miner_2";
		break;
		
		case "miner_2":
			dialog.text = "Sir, I'm loyal to my word.";
			link.l1 = "Very well. Then I wish you luck. This path leads to Willemstadt, follow it. It's not far from here.";
			link.l1.go = "miner_3";
		break;
		...
		case "cureer_1":
			...
			link.l1 = "Oh! Great news! Thank you, I shall depart immediately!";
			link.l1.go = "cureer_2";
		break;
		...
		case "burden_3":
			dialog.text = "I'm glad you've understood me correctly. And I will also ask you to pay a visit to the Chevalier the Poincy: he insisted on meeting you. We can't deny him such pleasure before his departure for Paris, can we? You will find him in the prison.";
