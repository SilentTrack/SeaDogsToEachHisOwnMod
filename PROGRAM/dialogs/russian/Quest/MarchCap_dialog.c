void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "MarchCap_1":
			...
			switch (rand(2))
			{
				case 0: //конвой у острова, установка параметров
					...
					dialog.text = "I managed to find out that in "+FindRussianDaysString(sti(pchar.GenQuest.MarchCap.DaysQty))+" a small trading convoy under the flag of "+NationNameGenitive(sti(pchar.GenQuest.MarchCap.Nation))+", two trade ships and one guard ship, will be sailing close o "+XI_ConvertString(pchar.GenQuest.MarchCap.Island.Shore+"Gen")+", this is not far from "+XI_ConvertString(pchar.GenQuest.MarchCap.Island+"Gen")+". The traders have a lot of "+GetGoodsNameAlt(sti(pchar.GenQuest.MarchCap.Goods))+" in their holds. It would be silly not to use this information, captain.\nYou and I can deal with the guards easily and take the cargo for ourselves. So, are you in?";
					link.l1 = "Sounds tempting. I'd say yes!";
					link.l1.go = "MarchCap_1_1";
					link.l2 = "Some"+GetGoodsNameAlt(sti(pchar.GenQuest.MarchCap.Goods))+" is not enough for me to spoil my relations with "+NationNameAblative(sti(pchar.GenQuest.MarchCap.Nation))+". No I am not buying this! Farewell, sir, and don't even try to stop me!";
				...
				case 2: //одиночный пиратский кулсейлор у бухты, установка параметров
					...
					link.l2 = "Hm. It looks like this prize is unreachable not only for you but for the both of us. No, I am but buying it, farewell, sir, and don't even try to stop me!";
					link.l2.go = "MarchCap_exit";
				break;
			}
		break;
		...
		case "MarchCap_AfterBattle":
			...
			if (iTemp < 50)
			{
				dialog.text = "You such a looser, captain! We didn't get a piece! And this is all because of you! You are the reason of our fault, damn you!";
				link.l1 = "Am I? Look at yourself! You haven't helped me in the battle! I have just wasted my time with you... Get lost from my ship!";
				link.l1.go = "MarchCap_Talk_exit";
			...
			if (iTemp > 50 && iTemp < 500)
			{
				...
				link.l1 = "If you had been helping me instead of counting birds in the sky, the raid would be successful... Take your share - "+FindRussianQtyString(sti(pchar.GenQuest.MarchCap.CapPart))+" and get lost!";
				link.l1.go = "MarchCap_Talk_exit";
			...
			{
				dialog.text = "Well done, captain! As I've said - it was relatively easy to empty cargo holds of those merchants, ha-ha... The prize is "+FindRussianQtyString(iQty)+" pieces. My share is "+FindRussianQtyString(sti(pchar.GenQuest.MarchCap.CapPart))+".";
			...
			dialog.text = "Splendid, captain! As I've said - it was relatively easy to empty cargo holds of those merchants, ha-ha... The prize is huge, much more than I have expected. It is "+FindRussianQtyString(iQty)+" pieces. My share is "+FindRussianQtyString(sti(pchar.GenQuest.MarchCap.CapPart))+".";
			link.l1 = "It is correct, "+npchar.name+". I have no objections. Longboats are being loaded right now. Perhaps we will do another raid together in the future? You look like a suitable companion for me.";
		...
		case "MarchCap_DieHard":
			...
			link.l1 = "And do you think I have supposed to do? To let that pirate to sink my ship? No way, I'd better be a living coward than a dead idiot!";
			link.l1.go = "MarchCap_DieHard_1";
		break;
		
		case "MarchCap_DieHard_1":
			dialog.text = "And why have I got involved with you, captain? I should have find a man who doesn't fear boarding sabers!";
			link.l1 = " Now I ask you to leave my ship - I need to repair it.";
			link.l1.go = "MarchCap_Talk_exit";
		break;
		...
		case "MarchCap_AfterBattleGold":
			...
			{
				dialog.text = "Well, this raid wasn't that successful as I have expected, our prize is really modest... Whatever, captain, let's share these scraps and say goodbye to each other.";
				link.l1 = "If you were helping me instead of counting birds in the sky, the raid would be successful... Take your share - "+FindRussianQtyString(sti(pchar.GenQuest.MarchCap.CapPart))+" and get lost!";
				link.l1.go = "MarchCap_Talk_exit";
				pchar.GenQuest.MarchCap = "poor";
				break;
			}
			if (iTemp > 100 && iTemp < 500)
			{
				...
				link.l1 = "It is correct, "+npchar.name+". I have no objections. LonbBoats are being loaded right now. Perhaps we will meet again...";
				link.l1.go = "MarchCap_Talk_exit";
				pchar.GenQuest.MarchCap = "good";
				break;
			}
			dialog.text = "Splendid, captain! As I've said - it was easy relatively, ha-ha... The prize is huge, much more than I have expected. It is "+FindRussianQtyString(iQty)+" pieces. My share is "+FindRussianQtyString(sti(pchar.GenQuest.MarchCap.CapPart))+".";
			link.l1 = "It is correct, "+npchar.name+". I have no objections. Longboats are being loaded right now. Perhaps we will do another raid together in the future? You look like a suitable companion for me.";
			link.l1.go = "MarchCap_Deck_continue";
			pchar.GenQuest.MarchCap = "exellent";
		break;
		...
		case "MarchCap_exit":
			dialog.text = "Hm... I ain't going to. Get lost! I will do it myself!";
