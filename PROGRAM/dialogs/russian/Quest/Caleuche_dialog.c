void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Tuttuat_69":
			dialog.text = "Manga Rosa is rare herb in Caribbean. It grows where peopl� walk not a lot. Stupid people pick it, dry it and smoke it. It is very stupid. NO SMOKE IT! Seek jungle and coves, secluded places where silly people not thread. Look carefully. For each potion I need five stems of Manga Rosa.";
