...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "carpenter_2":
			...
			dialog.text = "Our ship-builder "+GetFullName(sld)+" wants to talk. I believe he has some sort of business proposal. He saw you ship in our port and sent me to find you. Would you kindly accept the invitation?";
			link.l1 = "Fine. I'll pay you boss a visit once I finish my business in town.";
		...
		case "officer_3":
			dialog.text = "Don't play stupid, master! What barrels? You know that I am talking about the very barrels you recently unloaded from this sailor's vessel! You both will rot in the dungeons! Move the fu...";
			link.l1 = "";
		...
		case "officer_7":
			...
			link.l1 = "Exactly, lieutenant. I am not that stupid. You jolly cooperation with the shipbuilder is compromised now.";
		...
		case "officer_8":
			...
			link.l1 = "Isn't that clear? I need my resin back. The resin you and your pall have stolen from me.";
		...
		case "greguar_7":
			...
			link.l1 = "I do trust you, monseniour.";
		...
		case "pirate_2":
			dialog.text = "We shall bury your fancy suit here!";
			link.l1 = "The number of bastards are 'bout to decrease today!";
			link.l1.go = "exit";
