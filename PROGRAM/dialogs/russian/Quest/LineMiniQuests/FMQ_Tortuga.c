...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "girl":
			...
			dialog.text = "Oh, hello monsieur! Welcome to Tortuga! Such noble captains like yourself are rare guests here...";
			link.l1 = "Greetings, mademoiselle. Thank you for a warm welcome. But how so? I thought that such important port is always a place of interest for people much more noble than myself.";
			link.l1.go = "girl_1";
		break;
		
		case "girl_1":
			dialog.text = "Ah monsieur... You are a newcomer, am I right? You'll see it for yourself. You have no idea how hard it is to get worthy men for a dancing party in the governor's palace. Perhaps you...";
		...
		case "girl_3":
			dialog.text = "It will our pleasure! Thank you! I promise you, this is going to be interesting. (giggles) See you tonight!";
			link.l1 = "See you...";
			link.l1.go = "girl_4";
		break;
		...
		case "girl_5":
			...
			link.l1 = "Hey to you too, pretty one. One fine man has arrived to your port after all. Got a lot of things to do, but I hope that this island can offer enough entertainment options for a sea wolf such as myself.";
			link.l1.go = "girl_6";
		break;
		...
		case "girl_exit_2":
			dialog.text = "Ph-f. Whatever, I'll find us a more intriguing man. Farewell, stud.";
			link.l1 = "Good luck finding...";
			link.l1.go = "girl_exit_1";
		break;
		...
		case "wife":
			...
			link.l1 = "It a great honor and pleasure for me - to be here in your company. But what about the rest of the guests? Am I too early?";
			link.l1.go = "wife_1";
		break;
		...
		case "wife_4":
			...
			dialog.text = "Careful there, monsieur captain, or I will loose my head. (giggle) My husband doesn't give me a single centime lately, this dog bring courtesans to our house and pays me no attention!\nI know where he is keeping a pathetic share of his treasures, it's in a chest in his office. This is my money as well by the right of a wife and a woman. Help me get what he owes me and be rewarded... With gold and... who knows.";
			link.l1 = "This... is an interesting offer. Very well, madame, I will help you. Where is this chest and how to open it?";
			link.l1.go = "wife_5";
			link.l2 = "Very well, pretty one, I will get you the chest's contents. We shall get the money and have a very pleasant time together. What man can decline such an offer? Where is this chest and how to open it?";
			link.l2.go = "wife_6";
		...
		case "wife_9":
			dialog.text = "What a direct approach! I like men like yourself. I do have a business proposal to you, captain. I will find a way to compensate your efforts if you succeed.";
			link.l1 = "Go on.";
			link.l1.go = "wife_10";
		break;
		...
		case "wife_12":
			PlaySound("VOICE\Russian\Dama02.wav");
			dialog.text = "Careful there, monsieur captain, or I will loose my head. (giggle) My husband doesn't give me a single centime lately, this dog bring courtesans to our house and pays me no attention!\nI know where he is keeping a pathetic share of his treasures, it's in a chest in his office. This is my money as well by the right of a wife and by the of a woman. Help me get what he owes me and be rewarded... With gold and... who knows.";
			link.l1 = "Fine. Will do it. Where is this chest and how to open it?";
			link.l1.go = "wife_13";
			link.l2 = "Ha! No questions there, I can do that for such a woman like yourself. You won't regret it, beauty. We shall get the money and have a very pleasant time together. Where is this chest and how to open it?";
			link.l2.go = "wife_14";
			link.l3 = "No way, pretty one. To clean out a governor? I don't do that. Not in this manner anyway. Find yourself another performer for this play.";
		...
		case "wife_exit_2":
			dialog.text = "Brat! Get our of my sight! And don't even think to tell my husband about this! You'll regret it!";
		...
		case "wife_18":
			dialog.text = "Are you sure? I might be dangerous for you. Why put you life at risk, captain? Change you mind, please, I am begging you!";
			link.l1 = "Fine. Have it you way. Looking forward to see you tomorrow.";
			link.l1.go = "wife_17";
			link.l2 = "I have made my decision already. What should I do exactly?";
			link.l2.go = "wife_19";
		break;
		...
		case "wife_23":
			...
			{
				link.l1 = "There were plenty of diamonds but you will get nothing. You hired an assassin to kill me, whore! Do you really believe that I will share with you after all of this? Try opening you mouth and your husband will learn about you plan to rob him. So keep it shut.";
				link.l1.go = "wife_24";
			}
		break;
		...
		case "wife_25":
			...
			link.l1 = "I always have time for such woman like yourself. Shall we open wine?..";
			link.l1.go = "wife_sex";
		break;
		...
		case "wife_29":
			dialog.text = "Leave now, you insolent fellow, or they will throw you into the most wet and dark chamber of fort La Roche! I don't care about your threats! Get lost!";
			link.l1 = "...";
			link.l1.go = "wife_30";
		break;
		...
		case "pirate_2":
			dialog.text = "Funny, but you you look smarter than you really are. You work for that bitch? You know who is her husband? I used to think I know. Just recently, Levasseur has sent his loyal slave Kampacho to beat to death a respected merchant. This merchant had shown some sort of minor disrespect to the governor's wife during a ball or something. And this woman seduced me with her features and his doubloons\nThe duplicate key exists. I used to be a decent safebreaker back in France, so it was a child play. If it wasn't for a daughter of Lyons's commandant... I'd never gone pirate. Fuck it!";
			link.l1 = "This is all very sad, but let's talk business. Where is the duplicate key?";
			link.l1.go = "pirate_3";
		break;
		
		case "pirate_3":
			dialog.text = "Are you listening? I am out of this! I was smart enough to see what's coming! I am leaving this place forever as soon as my ship is ready to set sail. Do you want the key? Pay for it. Don't be greedy here, chance are soon you won't be needing money at all.";
		...
		case "pirate_4":
			dialog.text = "You do have a bright head. It was a right decision, friend. Good luck. Hope you will find a true loving woman one day.";
		...
		case "pirate_dublon":
			...
			link.l1 = "You know, I am thinking that you can live without them. The key. On the table.";
			link.l1.go = "pirate_7";
			if (GetCharacterItem(pchar, "gold_dublon") >= 50)
			{
		...
		case "mercen":
			...
			dialog.text = "Damn it! I didn't expect... Hell with the women! My master told me to avoid her kind. But job's job. I will get you after all.";
			link.l1 = "Well-well, pal... Looks like she wanted to screw me too, can't say I am surprised. Why should we keep fighting? Want a job? I got one. You have skill, I need people like you in my crew. Meal, bunk, wage and a fair share of plunder. What say you?";
