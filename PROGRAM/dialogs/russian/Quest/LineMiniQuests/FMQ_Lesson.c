...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "greguar_2":
			...
			link.l1 = "I can always use extra money. Michelle? My brother is in good health and he is bored. I envy him sometimes... Time to set sail!";
			link.l1.go = "exit";
		...
		case "greguar_11":
			...
			link.l1 = "But for what price! See - almost everyone of our squad are dead. We should retreat, Gregoire, no guarantees that there are no more warriors waiting for us. Plus, we simply lack numbers to carry the loot.";
			link.l1.go = "greguar_12";
		break;
		
		case "greguar_12":
			dialog.text = "Damn it! Sad as it is, but you are right, "+pchar.name+": even if the savages are all dead meat, we won't be able to carry away the cargo before the Dutch or the English land here. We must leave now! Screw this damned coast!";
			link.l1 = "...";
			link.l1.go = "greguar_10";
		break;
		...
		case "greguar_21":
			...
			link.l1 = "I see... What now? Are you killing me now?";
		...
		case "prosper_6":
			...
			else
			{
				if (n > 0)
				{
					link.l1 = "We shall give them a fight, boys! There are goods and money right behind this hill! We are here for them and we are not leaving. No way some bunch of redskins, even with muskets, can stop us! Let's bury the fuckers and finish the job!";
					link.l1.go = "prosper_7";
				}
				else
				{
					link.l1 = "Chances are against us in every possible way. Do not forget about the Dutch right behind us. ";
		...
		case "FMQL_beach_3":
			dialog.text = "Shall we, captain?";
			link.l1 = "Yeah. Thank you for your service. Stay away from a cup and we shall save you from that beauty. Let's go.";
