...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "UsurerDone":
			dialog.text = "Credit for a reputable negotiator, no problem. What amount do you need? Let's talk about it.";
			link.l1 = "All right. I'll load the hold and I'll count how much space is left. I'll figurate out the amount that I'm missing and then I'll come back to you.";
			link.l1.go = "exit";	
