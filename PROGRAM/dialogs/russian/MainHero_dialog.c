...
//navy <--
		...
		case "TalkSelf_SlavesToCrew":
	        ...
	        {
	            Dialog.Text = "None of the sailors want to join the crew.";
	            Link.l1 = "To hell with them!";
	    		Link.l1.go = "exit";
	        }
	        else
	        {
