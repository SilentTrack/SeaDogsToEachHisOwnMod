...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth_3":
			dialog.text = "Some dashing captain of the Spanish fleet. He has introduced himself as...oh.. I have clean forgotten it... Ah! Senor Diego. His name was Diego, but his surname... de Montagna or de Montoya. Something like that. He was listening me just like you was, thanked me and gone away. Never saw him since then.";
