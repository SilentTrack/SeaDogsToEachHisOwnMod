	...
	switch(Dialog.CurrentNode)
	{
		...
		case "mtraxx_34":
			...
			if (pchar.questTemp.Mtraxx == "pasq_late" || pchar.questTemp.Mtraxx == "pasq_sink" || pchar.questTemp.Mtraxx == "pasq_esc")
			{
				...
				dialog.text = "Ha! Charlie Prince, a brave captain! It's your new name in La Vega in case you didn't know� So, did you enjoy being a brute? No? Figures. This is how my brainless agents like Cutlass live: today he parties in a brothel, wasting all he made, next day he is at my doorsteps begging a couple of thousands to pay his crew filled with idiots, just like he is. Whatever. Ready to hear it?";
				link.l1 = "Sure!";
		...
		case "mtraxx_52":
			...
			link.l1 = "Yeah. There was a caravan, we did the job nice and clean. Then we split the spoils of it on a shore� but first I put a watchman with a spyglass on a hill. And it paid off since a Spanish squadron had appeared shortly lead by a heavy galleon.";
		...
		case "mtraxx_54":
            dialog.text = "I'll take care of it. We should learn more about Ignacio Marco. He might be working for someone� His 'interest' in my men is suspicious. What ship he flies?";
