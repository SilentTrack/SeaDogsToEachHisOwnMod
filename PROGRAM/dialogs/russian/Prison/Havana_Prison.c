...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		case "Mtraxx_1":
			...
			link.l1 = "It's just a personal matter. I've known him back in Europe, and was shocked by the news of his imprisonment, let alone the gossip that followed throughout the town. I would like to talk to him.";
			link.l1.go = "Mtraxx_2";
		break;
		
		case "Mtraxx_2":
            dialog.text = "Hm...";
			link.l1 = "Officer, maybe I could... compensate you for letting me visit him?";
			link.l1.go = "Mtraxx_3";
		break;
		...
		case "Mtraxx_5":
            dialog.text = "Indeed, my order is to deliver don Lope Montoro to the commandant directly. I guess he won't be leaving the cell quite yet. You can go see him though, while he is still here.";
