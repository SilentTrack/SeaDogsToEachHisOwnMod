...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
 	switch(Dialog.CurrentNode)
	{
		...
		case "Sharlie_4":
			dialog.text = "Fine, I have no reasons to say no. Deluc will be brought here soon. But I have to warn you that this fox will run away at the very first opportunity, so don't have any illusions about him.";
