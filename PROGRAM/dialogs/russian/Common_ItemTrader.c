...
// ============================================================================	   
	switch(Dialog.CurrentNode)
	{
		...
		break;
  		...
  		case "First time":
			dialog.text = NPCharSexPhrase(npchar, "Would you like to buy equipment for yourself or for your officers, captain? If so, you've come just to the right person!", "Oh, captain, I knew that you'd approach me! I can offer you equipment for you and your officers, and also many other needful things.");
			...
			{
				link.l4 = "Hey, I've found one interesting plant around. Could you tell me if it is used to brew potions or decoctions? It just seemed interesting to me. Can you take a look?";
		...
		case "Wine_Bottles":
			...
			link.l1 = "Alright, you don't have them - no problem. But you're getting it somewhere yourself, aren't you? Maybe you could tell me the name of your supplier, and I'd buy it directly from him. Or do you convey it from Europe?";
			link.l1.go = "Wine_Bottles_1";
		break;
		
		case "Wine_Bottles_1":
			dialog.text = "No, myself. I take it here. But simply I won't name the supplier to you. And for a thousand peso... perhaps, I will say...";
			if (makeint(Pchar.money) >= 1000)
            {
				link.l1 = "Fine. Here's your thousand - and now tell me, who your supplier is.";
				link.l1.go = "Wine_Bottles_2";
			}
			link.l2 = "Now the merchants have gone too far! Wouldn't it be too good for you? I'll do fine without your retailer, thanks.";
		...
		case "Wine_Repeat1":
			...
			link.l1 = "You have tricked, rascal! I 've just been at the store, "+pchar.questTemp.Wine.Name+" never was dealing in wine, as he himself told me that! Give me my money back!";
		...
		case "Wine_Repeat1_1":
			dialog.text = "Heh! He deals in wine, that's for damn sure. He just doesn't sell wine to any first comer - like several other goods, too. And there's a reason to that... If you want to buy wine from him, I can write him a note. He knows me and my handwriting, so, after he's read it, he will sell you that wine. Of course, this service is not free, either.";
			link.l1 = "That's an outrage! You've just taken a grand from me!";
			link.l1.go = "Wine_Repeat1_2";
		break;
		
		case "Wine_Repeat1_2":
			dialog.text = "I took thousand from you for information. And for a letter you have to pay separately two thousand peso, and in any way not less than that.";
			if (makeint(Pchar.money) >= 2000)
			{
				link.l1 = "Oh... You hucksters are so damn greedy. No wonder no one likes your kind. Oh well - here's your money, so go ahead and write the note.";
				link.l1.go = "Wine_Bottles_3";
			}
			link.l2 = "Now that's out of all reason. I'd rather abandon the whole affair, but I will not enrich such a cunning miser. And by that miser I mean you. Farewell.";
			link.l2.go = "Wine_Repeat1_goaway";
		break;
		
		case "Wine_Bottles_3":
			AddMoneyToCharacter(pchar, -2000);
			dialog.text = "You are a queer bird, captain! Sure, I realize that your purser does all the financial business, but you should use your own head too sometimes. You will have an opportunity to buy a decent lot of wines wholesale without my price markup and make a considerable profit. So let's not prevent each other from making coins, because it is you who look greedy now\nRight...(writing) Here, take this letter - "+pchar.questTemp.Wine.Name+"  will sell you the wine without any questions.";
			link.l1 = "I do hope so... If anything goes wrong again, I will be back. See ya!";
		...
		case "Wine_Repeat1_fail":
			...
			link.l1 = "Oh, shut up! You win, I'm leaving! Curse you "+ NPCharSexPhrase(npchar, "","") +", cormorant, that to you on the world to go!";
			link.l1.go = "exit";
		...
		case "Device_ItemTrader_1":
			...
			{
				dialog.text = "Hmm... Yeah, there was one strange guy. But he didn't tell me what that thing was, he just tired to sell it to me. But what would I need it for, if I have no idea what's it for? How will I resell it? So, I just refused"+ NPCharSexPhrase(npchar, "","") +" to him, and he went away";
		...
		case "mangarosa":
			...
			{
				dialog.text = LinkRandPhrase("Show it to me... Yes, that's an interesting plant. But, unfortunately, I can't tell you more than that. If it is indeed used for whatever purpose, it's unknown to me.","Let's see... Hmm... It looks like a medicinal plant, but I don't know anything about it. Sorry - I won't be able to help you.","Where is it? Hmm... No, I've never seen one before. It sure looks very interesting, but I have no clue what it's being used for...");
		...
		case "mangarosa_1":
			dialog.text = "Nomadic gypsies and savages show great interest in these plants. I saw once a gypsy paying a handful of gold for just one stem such as this one. But I have no idea what do they need it for.";
			link.l1 = "I see... Well, it's something at the least! Now I know where to ask further. Thank you very much!";
