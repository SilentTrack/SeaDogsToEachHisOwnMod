...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "prepare_convoy_quest":
			...
			{
				dialog.text = RandPhraseSimple("Ahhh, hell! I know who you are! Only a complete idiot would step on board of your ship as a passenger! Farewell!", "Oh, I know who you are! I will never set foot on board of your ship. I am no fool...");
		...
		case "prepare_convoy_quest_3":
			...
			dialog.text = "I need to be delivered to the tavern of " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + ", that in " + XI_ConvertString(GetIslandByCityName(npchar.GenQuest.GetPassenger_Destination) + "Dat") +
                          ", per " + FindRussianDaysString(sti(npchar.GenQuest.GetPassenger_Time)) + ", and for that I'll be paying you " + FindRussianMoneyString(sti(npchar.GenQuest.GetPassenger_Money)) + ". What do you say?";
			link.l1 = "I agree.";
		...
		case "complete_convoy_quest":
			dialog.text = "Thank you. You have fulfilled your obligations. I am at my destination, and your reward is due. Here you go.";
			Link.l1 = "Thank you.";
		...
		case "complete_convoy_quest_1":
			//слухи
			AddSimpleRumour(LinkRandPhrase("A person by the name of " + GetFullName(npchar) + " says that captain " + GetMainCharacterNameDat() + " can be trusted, since "+ GetSexPhrase("he","she") +" had easily delivered him " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + ".", 
				"Passenger named " + GetFullName(npchar) + " says that captain " + GetMainCharacterNameDat() + " can be trusted. "+ GetSexPhrase("He delivered","She delivered") +" him " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + " it safely.", 
		...
		case "convoy_DeskTalk":
			dialog.text = NPCStringReactionRepeat(LinkRandPhrase(RandSwear() + "Captain, the time has run out. When, damn it, shall I finally get to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Acc") + "?", 
						  RandSwear() + "Captain, just how much longer are you going to wander God knows where?! When are we getting to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + "?" , 
				...
				RandPhraseSimple("Captain, once again I have to open a question regarding your obligations. When are we getting to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + "?", "Captain, the second time I have to raise the question about my shipping. When, finally, we can see the coast of " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Gen") + "?"), 
				RandPhraseSimple(RandSwear() + "Captain, I am asking for the third time - when are we getting to " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Acc") + "?", "Captain, we've lost a hell of a time! When you brought me in " + XI_ConvertString("Colony" + npchar.GenQuest.GetPassenger_Destination + "Acc") + "?"), 
                "Listen Captain, this is really too much!", "block", 0, npchar, Dialog.CurrentNode);
            if (sti(npchar.GenQuest.GetPassenger_Money) > 100)
            {
				link.l1 = HeroStringReactionRepeat(RandPhraseSimple("Please excuse me - so much to do was tied up with my affairs... In seven days you will be where you need to be for certain.", "I am sorry, " + GetAddress_Form(NPChar) + ", I really couldn't have fulfilled my obligations to you. But don't you worry - we shall arrive in a week."),
					RandPhraseSimple("I must apologize to you once again. We shall arrive at your destination in a week.", "Once again, I am sorry. We shall arrive at your destination in a week."),
					RandPhraseSimple("And once again I must beg for your excuse... We shall arrive at your destination in a week.", "And once again, I am sorry. We shall arrive at your destination in a week, I promise."),
					"I understand, " + GetAddress_Form(NPChar) + ", but please, have patience... In seven days at most I shall deliver you to your destination point!", npchar, Dialog.CurrentNode);
    			link.l1.go = "convoy_DeskTalk_1";
			}
			link.l2 = HeroStringReactionRepeat(RandPhraseSimple("Oh, a passenger... I must have forgotten about you. I think you will find it much more comfortable in the hold, where you will no longer pester me.", "Well, I never! Strangers on my ship!.. Alright, meet my hold, then!"),
				"For a second time? You don't say so!.. Perhaps, I'll send you to the hold for sightseeing.",
				"For a third time? That's too bad, he-he... Well, buddy - welcome to my hold. You should not be walking around on the deck of my ship.",
		...
		case "convoy_DeskTalk_1":
			dialog.text = LinkRandPhrase("Alright, but I shall cut down your payment for the delay.", "Alright, I'll try to believe you... But keep in mind that I am going to cut down your fee!", "Well, there is nowhere for me to go, anyway, but keep in mind that I am going to cut your payment down....");
			Link.l1 = LinkRandPhrase("Alright.", "Fine, then...", "Alright, as you say.");
			link.l1.go = "convoy_DeskTalk_2";
		break;

		case "convoy_DeskTalk_2":
			dialog.text = RandPhraseSimple("I would like to believe that this time you are going to fulfill your obligation.", "I do hope that this is our last conversation on this unpleasant topic.");
			Link.l1 = "Of course.";
		...
		case "convoy_Prison_1":
			...
			{
    			Link.l1 = "And what else is there to understand? From now on you are my prisoner! Get to the hold!";
    			link.l1.go = "convoy_Prison_2";
            }
			Link.l2 = "Just kidding... In seven days we shall arrive at your town.";
			link.l2.go = "convoy_DeskTalk_1";
		break;
		
		case "convoy_Prison_2":
			dialog.text = RandSwear() + "You will pay for this, "+ GetSexPhrase("creep","stinker") +"!";
			Link.l1 = "Everybody says that - but in the end they all pay to me!";
			link.l1.go = "convoy_Prison_3";
		break;
		
		case "convoy_Prison_3":
			AddSimpleRumour(LinkRandPhrase("It came to common knowledge that a captain " + GetFullName(pchar) + " obliged to deliver a passenger by the name of " + GetFullName(npchar) + ", but didn't stay true to "+ GetSexPhrase("his","her") +" word. Besides, "+ GetSexPhrase("he took","she took") +" the poor guy prisoner. That's what happens when you trust strange people...", 
				"What's up with this world?! Captain " + GetFullName(pchar) + " imprisoned a poor guy by the name of " + GetFullName(npchar) + ", despite him being a passenger on his ship...", 
