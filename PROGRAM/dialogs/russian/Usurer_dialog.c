	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LoanUsurer": 
            ...
            if(CheckAttribute(Pchar, "Quest.Loans." + (NPC_Area)) && makeint(Pchar.Quest.Loans.(NPC_Area)) == true)
			{
				...
				{
					Link.l5 = "I owe you."+ FindRussianMoneyString(sti(Pchar.Quest.Loans.(NPC_Area).Result)) + LinkRandPhrase(". I am ready"+ GetSexPhrase("","�") +" ������� ����.", ". At this moment, I am good to repay the debt.", ".  At last, it's time to pay off.");
			...
			else
			{
				...
				{
					Link.l7 = LinkRandPhrase("I'd like to lend money out.","Would accept to keep a few sacks of silver?", "May I leave you some silver for an evil day?"); 
					Link.l7.go = "deposit";				
				}			
		...
		case "GiveTaskSlave_2":
			...
			LAi_LocationDisableOfficersGen(&Locations[FindLocation(pchar.location)], true); 
		break;
		...
		case "Takeslaves_5_win":
			...
			{
				dialog.text = "Sounds great but... hm. Looks like I was mistaken on you. What have you brought? "+ sTemp +" slaves? And what about the rest? And don't tell me that you have sunk it. �� ������"+ GetSexPhrase("","�") +" ��� ���������������, ���, ��� ��� ���� - �������� ������. �������� � ���� �����, �� ����� ������ ����� � ����� ������� ���.";
				link.l1 = "Take care.";
		...
		case "Slaveshore_5":
			...
			link.l1 = "Fine, I see that you are speaking the truth. Your luck that captain of the pinnace told me that our 'business' was uncovered. I'd have already killed you if he hasn't blabbed out. �� �� �� �������, ������ �������� �����, ��� � ���� ����� �� ������� ��� ��������!";
		...
		case "Wingalleon":
			...
			if(amount < 1) 
			{
				...
				link.l1 = "Dear sir, it wasn't a galleon... or a very a big galleon... Damn! It was a battleship! And haven't even warned me! But I have managed to board it. I have got "+ sTemp +" slaves and I'm ready ��� �� ��������. �������� ������ �������, �� ������ ��� " + FindRussianMoneyString(iSlaveMoney) + ". It would be great to get some compensation for your misinformation.";
		...
		case "Usurer_Escape_5":
			...
			CloseQuestHeader("Slavetrader");
			pchar.questTemp.Slavetrader = "wait1";
			LAi_LocationDisableOfficersGen(&Locations[FindLocation(pchar.location)], false); 
		break;
