...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "One of the clergymen of your parish asked me to investigate the house, where a Joachim Merryman was renting a roomЕ";
				link.l1.go = "caleuche";
			}
		break;
		...
		case "caleuche_4":
			...
			link.l1 = "And why didnТt you tell the inquisitors?";
		...
		case "caleuche_7":
			...
			link.l1 = "HmmЕ You imply that this is Merryman's work, too?";
