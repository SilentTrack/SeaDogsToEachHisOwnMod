...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "caleuche":
			...
			link.l1 = "I'll look into it myself. Perhaps all these gossips are but the ramblings of drunken hunters - therefore the Inquisition hasnТt taken them seriously. I'll head into the jungle to see it all with my own eyes.";
