...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	{		
		...
		//Jason ----------------------------------- ’ронометр јлекса ------------------------------------------
			if (CheckAttribute(npchar, "quest.sextant") && CheckAttribute(pchar, "questTemp.AlexClock") && pchar.location == "Pirates_shipyard" && !CheckAttribute(npchar, "quest.clock"))
			{
				...
				Link.l1 = "It looks like you need me for something it does. Usually you aren't quite as courteous.";
			...
			if (CheckAttribute(pchar, "questTemp.AlexClock") && pchar.questTemp.AlexClock == "clock" && pchar.location == "Pirates_shipyard")
			{
				...
				Link.l1 = "They've left. I asked them Цand they left.";
		...
		case "node_1":
			dialog.text = "Young people these days... You never get any respect. Hot heads, hard hands, what do you need?";
		...
		case "node_2":
			dialog.text = "Don't cross up your elders, puppy";
			link.l1 = pcharrepphrase("Easy, now. Calm down. Don't overexert yourself, or one beat could be the difference. I don't want to be accused for the death of the best shipwright on the Caribbean. Let's get down to business.",
				"I forgive you for your abruptness, only out of respect for your age. And now, if you've finished, let's get down to business.");
			link.l1.go = "node_3";
		...
		case "node_3":
			dialog.text = "Phew, phew... People won't leave an elder be. What do you need from me this time, " + GetAddress_Form(NPChar) + "? ";
		...
		case "shipyard_dlg":			
			...
			{
				dialog.Text = "I can propose to you a capital repair of your hull's frame. People don't have a clue on how to build decent ships here you set sail and it falls apart...";						
			...
			link.l2 = "I just want to use the services of the dockyard.";
			link.l2.go = "shipyard";
		...
		case "ship_repair_again":
			if((shipBaseHP - shipCurHP > 0) && (shipClass < 6))
			{
				...
				Link.l1 = "Yes. Right you are. Shall we have a look at what we can do?";
				Link.l1.go = "ship_repair_start";						   
			}
			else
			{
		...
		case "ship_tunning_not_now_2":
			dialog.Text = "Oh, I see you're still thinking! You'll go far! Come back when you decide what it is you want and don't bother me with trifling nonsense.";
			Link.l1 = RandPhraseSimple("Thank you! All the best.", "Bye, craftsman. Cut the sarcasm.");
            ...
            else
            {
			    ...
			    else
			    {
					...
					if( makefloat(shipCurHP)/makefloat(shipBaseHP) > 0.95)
                    {
						...
						Link.l1 = "Okay... Well, I'll drop on by sometime later...";
    			        Link.l1.go = "ship_tunning_not_now";
    			        break;
					}
    			    ...
    			    {
    			        s1 = s1 + " Bah! This ship's been in too many hands. Yeah and it's scuffed up to boot. Do you have a corsair patent? Just joking... anyway, back to the matter.";
    			    }
                    dialog.Text = s1;
		...
		case "ship_repair_HP":
			...
			s1 = s1 + " For the work I will charge: "+ HPPrice + " doubloons for the labor... My grandchildren has been calling me back  to Europe for a long time. I don't want to come back empty-handed you know... So, that'll be all. And oh yes Цthe money up front.";
            dialog.Text = s1;
			...
			Link.l2 = "No. I'm not happy with that.";
			Link.l2.go = "ship_tunning_not_now";
		break;
		
		case "ship_repair_HP_start_0":
			dialog.Text = "Yes... The payment... You can pay right away or you can send an errand boy to the ship for the necessary amount... What would you like to do?";
    ...
    " the shipmaster requires: ironwood - " + NPChar.Repair.Matherial1 + ", pitch - "+ NPChar.Repair.Matherial2 + ", ship silk - " + NPChar.Repair.Matherial3 + " ropes - " + NPChar.Repair.Matherial4 + 
		...
		case "ship_repair_HP_again":
		    ...
		    {
                NextDiag.TempNode = "ship_repair_HP_again";
				dialog.Text = "Clocks are ticking. Got what I asked?";
			...
			else
			{
			    ...
			    Link.l1 = "Yes, that's true. What a shame that the deposit is gone...";
			    Link.l1.go = "Exit";		    
		...
		case "ship_repair_HP_again_2":
			...
			{
				NextDiag.TempNode = "ship_repair_HP_again";
				dialog.Text = "Now what you still have left to bring me is: "+ sti(NPChar.Repair.Matherial1) + " of ironwood, "+ sti(NPChar.Repair.Matherial2) + " resins, " + NPChar.Repair.Matherial3 + " of ship silk, " + NPChar.Repair.Matherial4 + "ropes.";
				link.l1 = "All right.";
				link.l1.go = "Exit";

                AddQuestRecord("ShipRepair", "t1");
				AddQuestUserData("ShipRepair", "sText", "Materials left: ironwood - "+ NPChar.Repair.Matherial1 + ", pitch - "+ NPChar.Repair.Matherial2 + ", ship silk - " + NPChar.Repair.Matherial3 + " ropes - " + NPChar.Repair.Matherial4 + ".");
			}
		break;
		...
		case "ship_repair_HP_complite":
			...
			dialog.Text = "... Well that's about it... I guarantee you Цit'll be pretty tough to wreck this ship now!";
		...
		case "quests":
			...
			if ((pchar.questTemp.different == "GiveShipLetters") && !CheckAttribute(pchar, "questTemp.different.GiveShipLetters.speakAlexus"))
			{
				...
				link.l1.go = "Al_ShipLetters_1";// генератор  "Ќайденные документы"
		...
		break;
//*************************** √енератор - "Ќайденные судовые документы" **************
		
		case "Al_ShipLetters_1":
			dialog.text = "State you terms.";
			s1 = "I lucked into finding an absolutely legal ship's paper packet that hasn't been called for search yet.";
			s1 = s1 + "The ship is afloat and it hasn't been excluded from the registry, don't worry. Just the gaping fool-owner had the misfortune of losing these papers...";
			link.l1 = s1;
			link.l1.go = "Al_ShipLetters_2";			
		break;
		case "Al_ShipLetters_2":
			s1 = "Let me have a look see! It really does look to be freshly filled out. Well, may luck be in your favor, sir! ";
			s1 = s1 + "I was actually needing a packet just like this. I, in turn, will offer you " + sti(pchar.questTemp.different.GiveShipLetters.price5) + " pesos. What do you say?";
			dialog.text = s1;
...
//*************************** ќткрывание двери ***************************
 		case "Step_Door_1":
            ...
            link.l2 = "Well I never! Pay for some door.";
    		link.l2.go = "exit";
		break;
		...
		break;
 		...
 		case "Step_Door_3":
			dialog.text = "Well when you have them, come back. Otherwise, don't try to convince me. It's useless...";
	...
	// ------------------------------------------- хронометр Алекса ----------------------------------------------// Addon-2016 Jason замена дублонов на песо везде
		...
		case "clock_begin_1":
			...
			dialog.text = "Our new leader of the Brethren, "+sTotalTemp+", has ordered a new ship, a frigate. He also put quite difficult tasks: protected hull, fast speed and good maneuverability plus cannons of the biggest possible caliber\nI understand that admiral ship must be something special, but that means that I need special materials in order to build it. You must have heard of such. Ironwood, pitch, ship silk and ropes...";
			link.l1 = "So tell me about this president of the Brethren. Or are you leery that "+sTotalTemp+" will remove your head for it?";
			link.l1.go = "clock_begin_2";
		break;
		
		case "clock_begin_2":
			dialog.text = "I'd say... The thing is our new president has not that time nor the opportunity to amass these materials. You have to know what kind of a rarity it is. And there's no way I'll be able to build a frigate with the known characteristics without them.";
			link.l1 = "And  you probably propose that I take to searching for materials for the ship?";
			link.l1.go = "clock_begin_3";
		break;
		
		case "clock_begin_3":
			dialog.text = "Well, yes. You are a good friend of our president. "+sTotalTemp+" has said himself that he owes you a lot and that he demands all kind of respect for you... I was just thinking: since you're his friend, then maybe you wouldn't be against helping him? And that at the same time: you do realize what kind of an awkward position I'm in? All material will be paid for, "+sTotalTemp+" isn't tight with his gold.";
			link.l1 = "I'm quite sorry, craftsman, but I'm no less busy than "+sTotalTemp+". I'm afraid that collecting materials may take a whole eternity. So, you better ask somebody else.";
			link.l1.go = "clock_exit";
			link.l2 = "Well, if you're the ship orderer "+sTotalTemp+" - then of course I'll try to help. We are really friends, he and I, and friends need to be helped. How many materials do you need?";
		...
		case "clock_begin_4":
			dialog.text = "I'm missing 100 unites of ironwood, 150 containers of resins, 110 rolls of ship silk, and 90 coils of hemp ropes. Do you think you could find me all that in the course of four months? I don't think I have any longer.";
			link.l1 = "I can at least try. And as for the payment?";
			link.l1.go = "clock_begin_5";
		break;
		
		case "clock_begin_5":
			dialog.text = "Here are my rates: ironwood at 4000 pesos a piece, resins at 1400 pesos a container, silk at 2500 pesos per roll, and ropes at 1500 pesos per coil. And if you bring all the to me, you'll get a useful gift from me.";
			link.l1 = "What is it, I wonder?";
			link.l1.go = "clock_begin_6";
		break;
		
		case "clock_begin_6":
			dialog.text = "Bring me the materials first. But I assure you: it'll come well in handy for you, and their isn't another on the Caribbean, or in the whole world. I hope that little spark of curiosity kindles you interest into putting the materials together for me.";
			link.l1 = "Well, you're slick as a leprechaun, craftsman! All right, you've got yourself a deal.";
			link.l1.go = "clock_begin_7";
		break;
		
		case "clock_begin_7":
			dialog.text = "I'm very happy. I'll be looking forward to your return.";
			link.l1 = "I hope it doesn't take you too long...";
		...
		case "clock_1":
			...
			else
			{
				...
				link.l1 = "Alas, that's all for now. Just wait til later.";
				link.l1.go = "exit";
		...
		case "sandal": // бакаут
			...
			{
				iSum = 4000*amount;
				dialog.text = "Okay, okay. I'm also going to need "+FindRussianQtyString(amount)+"  of ironwood. You've brought me "+FindRussianQtyString(iSan)+". So, we've taken care of the ironwood now! All right, at the rate of 4000 pesos a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "oil": // смолы
			...
			{
				iSum = 1400*amount;
				dialog.text = "Okay, okay. I'm also going to need "+FindRussianQtyString(amount)+" resins. You've brought me "+FindRussianQtyString(iOil)+". So, we've taken care of the resins now! All right, at the rate of 1400 pesos a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "shipsilk": // шелк
			...
			{
				iSum = 2600*amount;
				dialog.text = "Okay, okay. I'm also going to need "+FindRussianQtyString(amount)+" silk. You've brought me "+FindRussianQtyString(iSil)+". So, we've taken care of the silk now! So, at the rate of 2600 pesos a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "ropes": // канаты
			...
			{
				iSum = 1500*amount;
				dialog.text = "Okay, okay. I'm also going to need "+FindRussianQtyString(amount)+" ropes. You've brought me "+FindRussianQtyString(iRop)+". So, we've taken care of the ropes already. All right, at the rate of 1500 pesos a piece, your reward totals at "+FindRussianMoneyString(iSum)+". Please, take it.";
				link.l1 = "Thank you!";
				link.l1.go = "clock_1";
		...
		case "clock_2":
			...
			link.l1 = "What is it craftsman? You look quite worried. Is something wrong? Are you up to some trouble?";
			link.l1.go = "clock_3";
		break;
		
		case "clock_3":
			dialog.text = "Precisely. Problems. Recent ones. Damn those treasure hunters...";
			link.l1 = "Calm down, calm down. It's not good at your age to be worrying like that. God forbid, you could be one beat away. Who would build the frigate for the president of the Brethren then? Calm down and explain to me Цwho are these treasure diggers?";
			link.l1.go = "clock_4";
		break;
		...
		case "clock_5":
			dialog.text = "Ah, sorry for my fantasies. Being old is not easy, young man. PardonЕ But it's irrelevant. What's relevant is that a box with a gift for you is in the chest which is lying in the dungeon currently occupied by some scum. They are not of our not, not from Isla Tesoro\nTreasure hunters, someone must had told them that this place is full of treasures. They won't dare to show themselves right here, however I am too scared to visit them, see? Their faces...";
			link.l1 = "I see. Open your door. I'll go smoke out your uninvited guests.";
			link.l1.go = "clock_6";
		break;
		
		case "clock_6":
			dialog.text = "Just like that? You'll go smoke them out? Alone? Aren't you scared?";
			link.l1 = "Less talk, more action, craftsman. Open this door and leave the rest to me. What chest are you keeping your things in?";
			link.l1.go = "clock_7";
		break;
		...
		case "clock_8":
			...
			pchar.quest.AlexClock_Over.over = "yes"; //сн€ть прерывание
		...
		case "clock_complete_1":
			dialog.text = "Oh, you're toying with an old man! All right. Give me my box and I'll open it up and give you the device you've earned fair and square.";
		...
		case "clock_complete_2":
			...
			dialog.text = "Gratitude! Let's open it. Here, take this. Automatic mechanical timer, they don't make such devices here and they won't for next three hundred years... huh, apologies, please forgive the old man. All I am saying that this thing is unique\nIt does all work itself, you won't need stupid sand clocks and so on. No errors! Just keep it safe from direct blows and water otherwise you will loose it. Even an ape can use this timer.";
			link.l1 = "Get a load of this! I've never seen anything so miraculous in my like! Thanks, craftsman.";
		...
		case "clock_complete_3":
			...
			dialog.text = "Welcome. Now you'll always know for sure what time it is. Don't ask me where I got it. I won't tell you.";
			link.l1 = "Everyone has their secrets, don't they craftsman? Keep your secret and I won't bud into your business. Thanks for the gift!";
			link.l1.go = "clock_complete_4";
		break;
		
		case "clock_complete_4":
			dialog.text = "And thank you for your help, captain. Come by and visit. Don't forget and the old shipwright.";
			link.l1 = "Like I could forget you... Anyway, I'll definitely do that, Alexus the craftsman. Goodbye!";
	...
	// <-- хронометр јлекса
		...
		case "tieyasal_1":
			dialog.text = "Oh, sorry, young man. Don't pay much attention to my bubbling... Our curious Michelle had satisfied his curiosity and disappeared. Only three days ago we had a chat.";
		...
		case "tieyasal_2":
			...
			link.l1 = "I see. Thanks, craftsman!";
		...
		//  алеуче
		case "FDM":
			dialog.text = "A-ha, the ghost ship! Moms scares their bad kids with it. Why would you need this damned vessel! Sailors get frightened when they see her at the horizonЕ What do you want to do with her?";
			...
			{
				link.l2 = "I am fed up with these torn black rags. I admit, they catch the wind as good as the normal sails but the viewЕ Disgusting. I want ordinary snow white sails. Are you in, master?";
				link.l2.go = "FDM_sails";
			}
		break;
		
		case "FDM_cabin":
			dialog.text = "Why not? My hands are still straight. Your galleon is huge, so I can even make a royal cabin like they build in battleships and mad-of-wars. Or we can keep a standard cabin. The choice is yours?";
			link.l1 = "Build the ship of the line cabin! They all will die of envy...";
		...
		case "FDM_cabin_m":
			dialog.text = "Fine. Ten chests of doubloons and I will see it done in five days.";
			link.l1 = "Deal.";
		...
		case "FDM_cabin_m1":
			...
			dialog.text = "Good, I shall be waiting for a payment.";
			if (iTemp > 0)
			{
		...
		case "FDM_cabin_pay":
			...
			else
			{
				...
				dialog.text = "So, you had to bring me "+FindRussianQtyString(sti(npchar.quest.FDM_cabin))+" more chests, you have brought "+FindRussianQtyString(iTemp)+". "+FindRussianQtyString(amount)+" chests left.";
		...
		case "FDM_cabin_do":
			...
			WaitDate("", 0, 0, 5, 0, 10); //крутим врем€
			LaunchFrameForm();
			RefreshLandTime();
		...
		case "FDM_sails":
			dialog.text = "Sure, I can do that! Well, wellЕ This means that we have to throw away every dirty old rag and place new and clear sails made of cotton. A lot of work to be done here. Hundred thousand pesos for work and materials. Deal?";
