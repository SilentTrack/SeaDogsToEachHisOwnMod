...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "guardoftruth_1":
			dialog.text = "'Admirable'... No wonder Цhe would just run around his galleon as if he was chasing his wife, just plain admiring it.";
			link.l1 = "I see. Is Gaius on Tortuga right now?";
			link.l1.go = "guardoftruth_2";
		break;
		
		case "guardoftruth_2":
			dialog.text = "No. He's set sail on his new ship and still hasn't returned to Tortuga. Where he took off ЦI have no clue. He didn't fill me in on that question.";
		...
		case "guardoftruth_3":
			dialog.text = "Oh, no problem. Stop by again, captain. And don't forget Цthere's always a space saved in my docks waiting for you ship next time you need some repairs!";
			link.l1 = "...";
			link.l1.go = "exit";
