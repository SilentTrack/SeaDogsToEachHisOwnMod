...
//----------------------------------------захват пассажиров дл€ выкупа------------------------------------------
			...
			case "passenger_4"://установка параметров
				pchar.quest.Marginpassenger_Over.over = "yes"; //сн€ть возможный таймер
